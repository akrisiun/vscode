 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "vs/platform/registry/common/platform", "vs/nls", "os", "vs/platform/actions/common/actions", "vs/platform/configuration/common/configurationRegistry", "vs/workbench/common/actions", "vs/base/common/platform", "vs/workbench/electron-browser/actions/developerActions", "vs/workbench/electron-browser/actions/windowActions", "vs/workbench/electron-browser/actions/workspaceActions", "vs/platform/contextkey/common/contextkey", "vs/platform/keybinding/common/keybindingsRegistry", "vs/platform/commands/common/commands", "vs/workbench/browser/contextkeys", "vs/workbench/common/editor", "vs/platform/electron/node/electron", "vs/platform/jsonschemas/common/jsonContributionRegistry"], function (require, exports, platform_1, nls, os, actions_1, configurationRegistry_1, actions_2, platform_2, developerActions_1, windowActions_1, workspaceActions_1, contextkey_1, keybindingsRegistry_1, commands_1, contextkeys_1, editor_1, electron_1, jsonContributionRegistry_1) {
    "use strict";
    ...
    (function registerActions() {
        ...
        (function registerDeveloperActions() {
            ...
            registry.registerWorkbenchAction(new actions_1.SyncActionDescriptor(developerActions_1.ConfigureRuntimeArgumentsAction, developerActions_1.ConfigureRuntimeArgumentsAction.ID, developerActions_1.ConfigureRuntimeArgumentsAction.LABEL), 'Developer: Configure Runtime Arguments', developerCategory);
