...
define(["require", "exports", "vs/platform/registry/common/platform", "vs/nls", "os", "vs/platform/actions/common/actions", "vs/platform/configuration/common/configurationRegistry", "vs/workbench/common/actions", "vs/base/common/platform", "vs/workbench/electron-browser/actions/developerActions", "vs/workbench/electron-browser/actions/windowActions", "vs/platform/contextkey/common/contextkey", "vs/platform/keybinding/common/keybindingsRegistry", "vs/platform/commands/common/commands", "vs/platform/contextkey/common/contextkeys", "vs/workbench/common/editor", "vs/platform/electron/node/electron", "vs/platform/jsonschemas/common/jsonContributionRegistry", "vs/platform/product/common/product"], function (require, exports, platform_1, nls, os, actions_1, configurationRegistry_1, actions_2, platform_2, developerActions_1, windowActions_1, contextkey_1, keybindingsRegistry_1, commands_1, contextkeys_1, editor_1, electron_1, jsonContributionRegistry_1, product_1) {
    ...
    (function registerActions() {
        ...
        (function registerZoomActions() {
            ...
            registry.registerWorkbenchAction(actions_1.SyncActionDescriptor.from(windowActions_1.ZoomInAction, { primary: 2048 /* CtrlCmd */ | 81 /* US_EQUAL */, secondary: [2048 /* CtrlCmd */ | 1024 /* Shift */ | 81 /* US_EQUAL */, 2048 /* CtrlCmd */ | 104 /* NUMPAD_ADD */] }), 'View: Zoom In', viewCategory);
            ...
            registry.registerWorkbenchAction(actions_1.SyncActionDescriptor.from(windowActions_1.ZoomResetAction, { primary: 2048 /* CtrlCmd */ | 93 /* NUMPAD_0 */ }), 'View: Reset Zoom', viewCategory);
        })();
        // Actions: Window
        (function registerWindowActions() {
            registry.registerWorkbenchAction(actions_1.SyncActionDescriptor.from(windowActions_1.CloseCurrentWindowAction, { primary: 2048 /* CtrlCmd */ | 1024 /* Shift */ | 53 /* KEY_W */ }), 'Close Window');
        ...
        (function registerDeveloperActions() {
            ...
            registry.registerWorkbenchAction(actions_1.SyncActionDescriptor.from(developerActions_1.ToggleSharedProcessAction), 'Developer: Toggle Shared Process', developerCategory);
            registry.registerWorkbenchAction(actions_1.SyncActionDescriptor.from(windowActions_1.ReloadWindowWithExtensionsDisabledAction), 'Developer: Reload With Extensions Disabled', developerCategory);
            registry.registerWorkbenchAction(actions_1.SyncActionDescriptor.from(developerActions_1.ToggleDevToolsAction), 'Developer: Toggle Developer Tools', developerCategory);
        ...
        (function registerRuntimeArgumentsAction() {
            ...
            registry.registerWorkbenchAction(actions_1.SyncActionDescriptor.from(developerActions_1.ConfigureRuntimeArgumentsAction), 'Preferences: Configure Runtime Arguments', preferencesCategory);
        })();
    })();
    // Menu
