...
define(["require", "exports", "./extHostTypes", "./extHost.protocol", "vs/nls", "vs/base/common/lifecycle"], function (require, exports, extHostTypes_1, extHost_protocol_1, nls_1, lifecycle_1) {
    ...
    let ExtHostStatusBarEntry = /** @class */ (() => {
        class ExtHostStatusBarEntry {
            constructor(proxy, commands, id, name, alignment = extHostTypes_1.StatusBarAlignment.Left, priority) {
            ...
            update() {
                ...
                this._timeoutHandle = setTimeout(() => {
                    ...
                    // Set to status bar
                    this._proxy.$setEntry(this.id, this._statusId, this._statusName, this.text, this.tooltip, (_a = this._command) === null || _a === void 0 ? void 0 : _a.internal, this.color, this._alignment === extHostTypes_1.StatusBarAlignment.Left ? 0 /* LEFT */ : 1 /* RIGHT */, this._priority);
                }, 0);
            }
            dispose() {
                this.hide();
