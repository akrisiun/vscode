...
define(["require", "exports", "vs/base/common/path", "vs/base/common/uri", "vs/base/node/pfs", "vs/workbench/api/common/extHostInitDataService", "vs/base/common/types", "vs/platform/log/common/log"], function (require, exports, path, uri_1, pfs, extHostInitDataService_1, types_1, log_1) {
    "use strict";
    ...
    let ExtensionStoragePaths = /** @class */ (() => {
        let ExtensionStoragePaths = class ExtensionStoragePaths {
            constructor(initData, _logService) {
