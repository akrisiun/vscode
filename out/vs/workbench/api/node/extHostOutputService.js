...
define(["require", "exports", "vs/base/common/uri", "vs/base/common/path", "vs/workbench/services/output/node/outputAppender", "vs/base/common/date", "vs/base/node/pfs", "vs/workbench/api/common/extHostOutput", "vs/workbench/api/common/extHostInitDataService", "vs/workbench/api/common/extHostRpcService", "vs/base/common/lifecycle", "vs/platform/log/common/log"], function (require, exports, uri_1, path_1, outputAppender_1, date_1, pfs_1, extHostOutput_1, extHostInitDataService_1, extHostRpcService_1, lifecycle_1, log_1) {
    ...
    let ExtHostOutputService2 = /** @class */ (() => {
