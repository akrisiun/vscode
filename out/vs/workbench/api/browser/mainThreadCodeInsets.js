...
define(["require", "exports", "vs/base/common/uri", "vs/workbench/api/common/extHost.protocol", "../common/extHostCustomers", "vs/editor/browser/services/codeEditorService", "vs/workbench/contrib/webview/browser/webview", "vs/base/common/lifecycle"], function (require, exports, uri_1, extHost_protocol_1, extHostCustomers_1, codeEditorService_1, webview_1, lifecycle_1) {
    "use strict";
    ...
    let MainThreadEditorInsets = class MainThreadEditorInsets {
        ...
        async $createEditorInset(handle, id, uri, line, height, options, extensionId, extensionLocation) {
            ...
            for (const candidate of this._editorService.listCodeEditors()) {
                if (candidate.getId() === id && candidate.hasModel() && candidate.getModel().uri.toString() === uri_1.URI.revive(uri).toString()) {
                    editor = candidate;
                    break;
                }
            }
