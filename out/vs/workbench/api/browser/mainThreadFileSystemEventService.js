...
define(["require", "exports", "vs/base/common/lifecycle", "vs/platform/files/common/files", "vs/workbench/api/common/extHostCustomers", "../common/extHost.protocol", "vs/workbench/services/textfile/common/textfiles", "vs/platform/progress/common/progress", "vs/nls", "vs/platform/configuration/common/configurationRegistry", "vs/platform/registry/common/platform", "vs/platform/configuration/common/configuration", "vs/platform/log/common/log", "vs/workbench/services/workingCopy/common/workingCopyFileService"], function (require, exports, lifecycle_1, files_1, extHostCustomers_1, extHost_protocol_1, textfiles_1, progress_1, nls_1, configurationRegistry_1, platform_1, configuration_1, log_1, workingCopyFileService_1) {
    "use strict";
    ...
    let MainThreadFileSystemEventService = /** @class */ (() => {
        let MainThreadFileSystemEventService = class MainThreadFileSystemEventService {
            constructor(extHostContext, fileService, textFileService, progressService, configService, logService, workingCopyFileService) {
