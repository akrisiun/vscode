...
define(["require", "exports", "vs/nls", "vs/base/common/errors", "vs/base/common/lifecycle", "vs/base/common/objects", "vs/base/common/uri", "vs/editor/browser/services/bulkEditService", "vs/editor/browser/services/codeEditorService", "vs/platform/commands/common/commands", "vs/platform/editor/common/editor", "vs/platform/opener/common/opener", "vs/workbench/api/common/extHost.protocol", "vs/workbench/api/common/shared/editor", "vs/workbench/services/editor/common/editorService", "vs/workbench/services/editor/common/editorGroupsService", "vs/workbench/contrib/files/common/openWith", "vs/platform/configuration/common/configuration", "vs/platform/quickinput/common/quickInput"], function (require, exports, nls_1, errors_1, lifecycle_1, objects_1, uri_1, bulkEditService_1, codeEditorService_1, commands_1, editor_1, opener_1, extHost_protocol_1, editor_2, editorService_1, editorGroupsService_1, openWith_1, configuration_1, quickInput_1) {
    "use strict";
    ...
    commands_1.CommandsRegistry.registerCommand('_workbench.openWith', (accessor, args) => {
        ...
        return openWith_1.openEditorWith(input, id, textOptions, group, editorService, configurationService, quickInputService);
    });
