...
define(["require", "exports", "vs/workbench/contrib/terminal/browser/links/terminalLinkHelpers", "vs/workbench/contrib/terminal/browser/links/terminalLink", "vs/platform/instantiation/common/instantiation", "vs/base/common/resources", "vs/platform/commands/common/commands", "vs/platform/workspace/common/workspace", "vs/workbench/services/host/browser/host"], function (require, exports, terminalLinkHelpers_1, terminalLink_1, instantiation_1, resources_1, commands_1, workspace_1, host_1) {
    ...
    let TerminalValidatedLocalLinkProvider = /** @class */ (() => {
        let TerminalValidatedLocalLinkProvider = class TerminalValidatedLocalLinkProvider {
            ...
            async provideLink(position, callback) {
                var _a, _b;
                ...
                const text = terminalLinkHelpers_1.getXtermLineContent(this._xterm.buffer.active, startLine, endLine);
                ...
                while ((match = rex.exec(text)) !== null) {
                    ...
                    if (terminalLinkHelpers_1.positionIsInRange(position, bufferRange)) {
            ...
            get _localLinkRegex() {
                const baseLocalLinkClause = this._processOperatingSystem === 1 /* Windows */ ? winLocalLinkClause : unixLocalLinkClause;
        ...
        return TerminalValidatedLocalLinkProvider;
    })();
