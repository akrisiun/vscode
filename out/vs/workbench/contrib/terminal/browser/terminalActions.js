...
define(["require", "exports", "vs/base/common/actions", "vs/editor/browser/services/codeEditorService", "vs/workbench/contrib/terminal/common/terminal", "vs/base/browser/ui/actionbar/actionbar", "vs/workbench/services/layout/browser/layoutService", "vs/platform/theme/common/styler", "vs/platform/theme/common/themeService", "vs/platform/quickinput/common/quickInput", "vs/platform/contextview/browser/contextView", "vs/platform/commands/common/commands", "vs/platform/workspace/common/workspace", "vs/workbench/browser/actions/workspaceCommands", "vs/platform/notification/common/notification", "vs/workbench/services/configurationResolver/common/configurationResolver", "vs/workbench/services/history/common/history", "vs/base/common/network", "vs/base/common/platform", "vs/base/common/types", "vs/workbench/contrib/terminal/browser/terminal", "vs/platform/actions/common/actions", "vs/workbench/contrib/terminal/browser/terminalQuickAccess", "vs/workbench/browser/actions/layoutActions", "vs/workbench/common/views", "vs/platform/contextkey/common/contextkey", "vs/base/browser/dom", "vs/platform/theme/common/colorRegistry", "vs/nls", "vs/platform/accessibility/common/accessibility"], function (require, exports, actions_1, codeEditorService_1, terminal_1, actionbar_1, layoutService_1, styler_1, themeService_1, quickInput_1, contextView_1, commands_1, workspace_1, workspaceCommands_1, notification_1, configurationResolver_1, history_1, network_1, platform_1, types_1, terminal_2, actions_2, terminalQuickAccess_1, layoutActions_1, views_1, contextkey_1, dom_1, colorRegistry_1, nls_1, accessibility_1) {
    ...
    let ToggleTerminalAction = /** @class */ (() => {
     ...
     */
    let CopyTerminalSelectionAction = /** @class */ (() => {
    ...
    let SelectAllTerminalAction = /** @class */ (() => {
    ...
    let CreateNewTerminalAction = /** @class */ (() => {
    ...
    let SplitInActiveWorkspaceTerminalAction = /** @class */ (() => {
    ...
    let SelectDefaultShellWindowsTerminalAction = /** @class */ (() => {
    ...
    let SwitchTerminalAction = /** @class */ (() => {
    ...
    let SwitchTerminalActionViewItem = /** @class */ (() => {
        let SwitchTerminalActionViewItem = class SwitchTerminalActionViewItem extends actionbar_1.SelectActionViewItem {
            constructor(action, _terminalService, _themeService, contextViewService) {
                super(null, action, getTerminalSelectOpenItems(_terminalService), _terminalService.activeTabIndex, contextViewService, { ariaLabel: nls_1.localize('terminals', 'Open Terminals.') });
                this._terminalService = _terminalService;
        ...
        return SwitchTerminalActionViewItem;
    })();
        ...
        actions_2.registerAction2(class extends actions_2.Action2 {
            constructor() {
                super({
                    ...
                    title: nls_1.localize('workbench.action.terminal.newInActiveWorkspace', "Create New Integrated Terminal (In Active Workspace)"),
                    f1: true,
                    category
                });
            }
        ...
        actions_2.registerAction2(class extends actions_2.Action2 {
            constructor() {
                super({
                    ...
                    title: nls_1.localize('workbench.action.terminal.focusPreviousPane', "Focus Previous Pane"),
                    f1: true,
                    category,
                    keybinding: {
        ...
        actions_2.registerAction2(class extends actions_2.Action2 {
            constructor() {
                super({
                    ...
                    title: nls_1.localize('workbench.action.terminal.focusNextPane', "Focus Next Pane"),
                    f1: true,
                    category,
                    keybinding: {
        ...
        actions_2.registerAction2(class extends actions_2.Action2 {
            constructor() {
                super({
                    ...
                    title: nls_1.localize('workbench.action.terminal.resizePaneLeft', "Resize Pane Left"),
                    f1: true,
                    category,
                    keybinding: {
        ...
        actions_2.registerAction2(class extends actions_2.Action2 {
            constructor() {
                super({
                    ...
                    title: nls_1.localize('workbench.action.terminal.resizePaneRight', "Resize Pane Right"),
                    f1: true,
                    category,
                    keybinding: {
        ...
        actions_2.registerAction2(class extends actions_2.Action2 {
            constructor() {
                super({
                    ...
                    title: nls_1.localize('workbench.action.terminal.resizePaneUp', "Resize Pane Up"),
                    f1: true,
                    category,
                    keybinding: {
        ...
        actions_2.registerAction2(class extends actions_2.Action2 {
            constructor() {
                super({
                    ...
                    title: nls_1.localize('workbench.action.terminal.resizePaneDown', "Resize Pane Down"),
                    f1: true,
                    category,
                    keybinding: {
        ...
        actions_2.registerAction2(class extends actions_2.Action2 {
            constructor() {
                super({
                    ...
                    title: nls_1.localize('workbench.action.terminal.focus', "Focus Terminal"),
                    f1: true,
                    category
                });
            }
        ...
        actions_2.registerAction2(class extends actions_2.Action2 {
            constructor() {
                super({
                    ...
                    title: nls_1.localize('workbench.action.terminal.focusNext', "Focus Next Terminal"),
                    f1: true,
                    category
                });
            }
        ...
        actions_2.registerAction2(class extends actions_2.Action2 {
            constructor() {
                super({
                    ...
                    title: nls_1.localize('workbench.action.terminal.focusPrevious', "Focus Previous Terminal"),
                    f1: true,
                    category
                });
            }
        ...
        actions_2.registerAction2(class extends actions_2.Action2 {
            constructor() {
                super({
                    ...
                    title: nls_1.localize('workbench.action.terminal.runSelectedText', "Run Selected Text In Active Terminal"),
                    f1: true,
                    category
                });
            }
        ...
        actions_2.registerAction2(class extends actions_2.Action2 {
            constructor() {
                super({
                    ...
                    title: nls_1.localize('workbench.action.terminal.runActiveFile', "Run Active File In Active Terminal"),
                    f1: true,
                    category
                });
            }
        ...
        actions_2.registerAction2(class extends actions_2.Action2 {
            constructor() {
                super({
                    ...
                    title: nls_1.localize('workbench.action.terminal.scrollDown', "Scroll Down (Line)"),
                    f1: true,
                    category,
                    keybinding: {
        ...
        actions_2.registerAction2(class extends actions_2.Action2 {
            constructor() {
                super({
                    ...
                    title: nls_1.localize('workbench.action.terminal.scrollDownPage', "Scroll Down (Page)"),
                    f1: true,
                    category,
                    keybinding: {
        ...
        actions_2.registerAction2(class extends actions_2.Action2 {
            constructor() {
                super({
                    ...
                    title: nls_1.localize('workbench.action.terminal.scrollToBottom', "Scroll to Bottom"),
                    f1: true,
                    category,
                    keybinding: {
        ...
        actions_2.registerAction2(class extends actions_2.Action2 {
            constructor() {
                super({
                    ...
                    title: nls_1.localize('workbench.action.terminal.scrollUp', "Scroll Up (Line)"),
                    f1: true,
                    category,
                    keybinding: {
        ...
        actions_2.registerAction2(class extends actions_2.Action2 {
            constructor() {
                super({
                    ...
                    title: nls_1.localize('workbench.action.terminal.scrollUpPage', "Scroll Up (Page)"),
                    f1: true,
                    category,
                    keybinding: {
        ...
        actions_2.registerAction2(class extends actions_2.Action2 {
            constructor() {
                super({
                    ...
                    title: nls_1.localize('workbench.action.terminal.scrollToTop', "Scroll to Top"),
                    f1: true,
                    category,
                    keybinding: {
        ...
        actions_2.registerAction2(class extends actions_2.Action2 {
            constructor() {
                super({
                    ...
                    title: nls_1.localize('workbench.action.terminal.navigationModeExit', "Exit Navigation Mode"),
                    f1: true,
                    category,
                    keybinding: {
                        primary: 9 /* Escape */,
        ...
        actions_2.registerAction2(class extends actions_2.Action2 {
            constructor() {
                super({
                    ...
                    title: nls_1.localize('workbench.action.terminal.navigationModeFocusPrevious', "Focus Previous Line (Navigation Mode)"),
                    f1: true,
                    category,
                    keybinding: {
        ...
        actions_2.registerAction2(class extends actions_2.Action2 {
            constructor() {
                super({
                    ...
                    title: nls_1.localize('workbench.action.terminal.navigationModeFocusNext', "Focus Next Line (Navigation Mode)"),
                    f1: true,
                    category,
                    keybinding: {
        ...
        actions_2.registerAction2(class extends actions_2.Action2 {
            constructor() {
                super({
                    ...
                    title: nls_1.localize('workbench.action.terminal.clearSelection', "Clear Selection"),
                    f1: true,
                    category,
                    keybinding: {
                        primary: 9 /* Escape */,
        ...
        actions_2.registerAction2(class extends actions_2.Action2 {
            constructor() {
                super({
                    ...
                    title: nls_1.localize('workbench.action.terminal.manageWorkspaceShellPermissions', "Manage Workspace Shell Permissions"),
                    f1: true,
                    category
                });
            }
        ...
        actions_2.registerAction2(class extends actions_2.Action2 {
            constructor() {
                super({
                    ...
                    title: nls_1.localize('workbench.action.terminal.rename', "Rename"),
                    f1: true,
                    category
                });
            }
        ...
        actions_2.registerAction2(class extends actions_2.Action2 {
            constructor() {
                super({
                    ...
                    title: nls_1.localize('workbench.action.terminal.focusFind', "Focus Find"),
                    f1: true,
                    category,
                    keybinding: {
        ...
        actions_2.registerAction2(class extends actions_2.Action2 {
            constructor() {
                super({
                    ...
                    title: nls_1.localize('workbench.action.terminal.hideFind', "Hide Find"),
                    f1: true,
                    category,
                    keybinding: {
                        primary: 9 /* Escape */,
        ...
        actions_2.registerAction2(class extends actions_2.Action2 {
            constructor() {
                super({
                    ...
                    title: nls_1.localize('quickAccessTerminal', "Switch Active Terminal"),
                    f1: true,
                    category
                });
            }
        ...
        actions_2.registerAction2(class extends actions_2.Action2 {
            constructor() {
                super({
                    ...
                    title: nls_1.localize('workbench.action.terminal.scrollToPreviousCommand', "Scroll To Previous Command"),
                    f1: true,
                    category,
                    keybinding: {
        ...
        actions_2.registerAction2(class extends actions_2.Action2 {
            constructor() {
                super({
                    ...
                    title: nls_1.localize('workbench.action.terminal.scrollToNextCommand', "Scroll To Next Command"),
                    f1: true,
                    category,
                    keybinding: {
        ...
        actions_2.registerAction2(class extends actions_2.Action2 {
            constructor() {
                super({
                    ...
                    title: nls_1.localize('workbench.action.terminal.selectToPreviousCommand', "Select To Previous Command"),
                    f1: true,
                    category,
                    keybinding: {
        ...
        actions_2.registerAction2(class extends actions_2.Action2 {
            constructor() {
                super({
                    ...
                    title: nls_1.localize('workbench.action.terminal.selectToNextCommand', "Select To Next Command"),
                    f1: true,
                    category,
                    keybinding: {
        ...
        actions_2.registerAction2(class extends actions_2.Action2 {
            constructor() {
                super({
                    ...
                    title: nls_1.localize('workbench.action.terminal.selectToPreviousLine', "Select To Previous Line"),
                    f1: true,
                    category
                });
            }
        ...
        actions_2.registerAction2(class extends actions_2.Action2 {
            constructor() {
                super({
                    ...
                    title: nls_1.localize('workbench.action.terminal.selectToNextLine', "Select To Next Line"),
                    f1: true,
                    category
                });
            }
        ...
        actions_2.registerAction2(class extends actions_2.Action2 {
            constructor() {
                super({
                    ...
                    title: nls_1.localize('workbench.action.terminal.toggleEscapeSequenceLogging', "Toggle Escape Sequence Logging"),
                    f1: true,
                    category
                });
            }
        ...
        actions_2.registerAction2(class extends actions_2.Action2 {
            constructor() {
                super({
                    ...
                    title: nls_1.localize('workbench.action.terminal.toggleFindRegex', "Toggle Find Using Regex"),
                    f1: true,
                    category,
                    keybinding: {
        ...
        actions_2.registerAction2(class extends actions_2.Action2 {
            constructor() {
                super({
                    ...
                    title: nls_1.localize('workbench.action.terminal.toggleFindWholeWord', "Toggle Find Using Whole Word"),
                    f1: true,
                    category,
                    keybinding: {
        ...
        actions_2.registerAction2(class extends actions_2.Action2 {
            constructor() {
                super({
                    ...
                    title: nls_1.localize('workbench.action.terminal.toggleFindCaseSensitive', "Toggle Find Using Case Sensitive"),
                    f1: true,
                    category,
                    keybinding: {
        ...
        actions_2.registerAction2(class extends actions_2.Action2 {
            constructor() {
                super({
                    ...
                    title: nls_1.localize('workbench.action.terminal.findNext', "Find Next"),
                    f1: true,
                    category,
                    keybinding: [
                        {
        ...
        actions_2.registerAction2(class extends actions_2.Action2 {
            constructor() {
                super({
                    ...
                    title: nls_1.localize('workbench.action.terminal.findPrevious', "Find Previous"),
                    f1: true,
                    category,
                    keybinding: [
                        {
        ...
        actions_2.registerAction2(class extends actions_2.Action2 {
            constructor() {
                super({
                    ...
                    title: nls_1.localize('workbench.action.terminal.relaunch', "Relaunch Active Terminal"),
                    f1: true,
                    category
                });
            }
        ...
        actions_2.registerAction2(class extends actions_2.Action2 {
            constructor() {
                super({
                    ...
                    title: nls_1.localize('workbench.action.terminal.showEnvironmentInformation', "Show Environment Information"),
                    f1: true,
                    category
                });
            }
