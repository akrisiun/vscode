        ...
        let TerminalInstance = class TerminalInstance extends lifecycle_1.Disposable {
            ...
            async _createXterm() {
                ...
                this._processManager.onProcessReady(() => {
                    ...
                    this._linkManager = this._instantiationService.createInstance(terminalLinkManager_1.TerminalLinkManager, xterm, this._processManager, this._configHelper);
