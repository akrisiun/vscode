...
define(["require", "exports", "vs/nls", "vs/base/common/actions", "vs/platform/environment/common/environment", "vs/platform/localizations/common/localizations", "vs/platform/quickinput/common/quickInput", "vs/workbench/services/configuration/common/jsonEditing", "vs/workbench/services/host/browser/host", "vs/platform/notification/common/notification", "vs/base/common/platform", "vs/base/common/arrays", "vs/workbench/contrib/extensions/common/extensions", "vs/workbench/services/viewlet/browser/viewlet", "vs/platform/dialogs/common/dialogs"], function (require, exports, nls_1, actions_1, environment_1, localizations_1, quickInput_1, jsonEditing_1, host_1, notification_1, platform_1, arrays_1, extensions_1, viewlet_1, dialogs_1) {
    ...
    let ConfigureLocaleAction = class ConfigureLocaleAction extends actions_1.Action {
        ...
        async getLanguageOptions() {
            ...
            const availableLanguages = ['en', ...await this.localizationService.getLanguageIds(2 /* Contributed */)];
