    ...
    class AccessibilityProvider {
        ...
        getAriaLabel(element) {
            if (this.getDirection() === 2 /* CallsFrom */) {
                ...
                return nls_1.localize('to', "callers fo {0}", element.item.name);
            }
        }
    }
