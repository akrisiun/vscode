...
define(["require", "exports", "vs/workbench/contrib/notebook/common/notebookCommon", "vs/workbench/contrib/notebook/browser/notebookRegistry", "vs/base/browser/dom", "vs/base/common/types", "vs/platform/instantiation/common/instantiation", "vs/editor/common/services/modelService", "vs/editor/common/services/modeService", "vs/editor/browser/widget/codeEditorWidget", "vs/base/common/uri", "vs/workbench/contrib/notebook/browser/view/renderers/mdRenderer"], function (require, exports, notebookCommon_1, notebookRegistry_1, DOM, types_1, instantiation_1, modelService_1, modeService_1, codeEditorWidget_1, uri_1, mdRenderer_1) {
    ...
    let RichRenderer = /** @class */ (() => {
        let RichRenderer = class RichRenderer {
            constructor(notebookEditor, instantiationService, modelService, modeService) {
                ...
                this._mdRenderer = instantiationService.createInstance(mdRenderer_1.MarkdownRenderer);
    ...
    notebookRegistry_1.registerOutputTransform('notebook.output.rich', notebookCommon_1.CellOutputKind.Rich, RichRenderer);
