...
define(["require", "exports", "vs/base/browser/dom", "vs/base/common/async", "vs/base/common/cancellation", "vs/base/common/lifecycle", "vs/editor/common/services/modeService", "vs/nls", "vs/platform/quickinput/common/quickInput", "vs/workbench/contrib/notebook/browser/constants", "vs/workbench/contrib/notebook/browser/notebookBrowser", "vs/workbench/contrib/notebook/browser/notebookService", "vs/workbench/contrib/notebook/browser/view/renderers/sizeObserver", "vs/workbench/contrib/notebook/common/notebookCommon", "vs/base/browser/keyboardEvent"], function (require, exports, DOM, async_1, cancellation_1, lifecycle_1, modeService_1, nls, quickInput_1, constants_1, notebookBrowser_1, notebookService_1, sizeObserver_1, notebookCommon_1, keyboardEvent_1) {
    "use strict";
    ...
    let CodeCell = /** @class */ (() => {
        let CodeCell = class CodeCell extends lifecycle_1.Disposable {
            constructor(notebookEditor, viewCell, templateData, notebookService, quickInputService, _modeService) {
                ...
                updateForFocusMode();
                (_b = templateData.editor) === null || _b === void 0 ? void 0 : _b.updateOptions({ readOnly: !(viewCell.getEvaluatedMetadata((_c = notebookEditor.viewModel) === null || _c === void 0 ? void 0 : _c.metadata).editable) });
                this._register(viewCell.onDidChangeState((e) => {
                    var _a, _b;
                    if (e.metadataChanged) {
                        (_a = templateData.editor) === null || _a === void 0 ? void 0 : _a.updateOptions({ readOnly: !(viewCell.getEvaluatedMetadata((_b = notebookEditor.viewModel) === null || _b === void 0 ? void 0 : _b.metadata).editable) });
                    }
                }));
                this._register(viewCell.onDidChangeState((e) => {
                    var _a, _b;
            ...
            renderOutput(currOutput, index, beforeElement) {
                ...
                if (currOutput.outputKind === notebookCommon_1.CellOutputKind.Rich) {
                    ...
                    if (pickedMimeTypeRenderer.isResolved) {
                        // html
                        result = this.notebookEditor.getOutputRenderer().render({ outputKind: notebookCommon_1.CellOutputKind.Rich, data: { 'text/html': pickedMimeTypeRenderer.output } }, outputItemDiv, 'text/html');
                    }
                    else {
