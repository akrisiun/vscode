        ...
        dedupeConfiguredAndRecent(recentTasks, configuredTasks) {
            ...
            for (let j = 0; j < configuredTasks.length; j++) {
                ...
                const findIndex = recentTasks.findIndex((value) => {
                    var _a, _b;
                    return (workspaceFolder && definition && ((_a = value.getWorkspaceFolder()) === null || _a === void 0 ? void 0 : _a.uri.toString()) === workspaceFolder && ((_b = value.getDefinition()) === null || _b === void 0 ? void 0 : _b._key) === definition)
