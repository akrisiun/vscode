            ...
            runTaskCommand(arg) {
                ...
                if (identifier !== undefined) {
                    this.getGroupedTasks().then(async (grouped) => {
                        ...
                        folders = folders.concat([taskService_1.USER_TASKS_GROUP_KEY]);
