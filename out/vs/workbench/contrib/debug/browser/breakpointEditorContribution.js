...
define(["require", "exports", "vs/nls", "vs/base/common/platform", "vs/base/browser/dom", "vs/base/common/severity", "vs/base/common/actions", "vs/editor/common/core/range", "vs/editor/browser/editorExtensions", "vs/platform/instantiation/common/instantiation", "vs/platform/contextkey/common/contextkey", "vs/platform/contextview/browser/contextView", "vs/workbench/contrib/debug/browser/debugActions", "vs/workbench/contrib/debug/common/debug", "vs/base/browser/contextmenu", "vs/platform/dialogs/common/dialogs", "vs/workbench/contrib/debug/browser/breakpointWidget", "vs/base/common/lifecycle", "vs/base/common/htmlContent", "vs/workbench/contrib/debug/browser/breakpointsView", "vs/base/common/uuid", "vs/base/common/decorators", "vs/base/browser/mouseEvent", "vs/base/common/arrays", "vs/base/common/async"], function (require, exports, nls, env, dom, severity_1, actions_1, range_1, editorExtensions_1, instantiation_1, contextkey_1, contextView_1, debugActions_1, debug_1, contextmenu_1, dialogs_1, breakpointWidget_1, lifecycle_1, htmlContent_1, breakpointsView_1, uuid_1, decorators_1, mouseEvent_1, arrays_1, async_1) {
    ...
    function createBreakpointDecorations(model, breakpoints, debugService) {
        const result = [];
    ...
    function getBreakpointDecorationOptions(model, breakpoint, debugService) {
    ...
    let BreakpointEditorContribution = class BreakpointEditorContribution {
        constructor(editor, debugService, contextMenuService, instantiationService, contextKeyService, dialogService) {
            this.editor = editor;
        ...
        getId() {
            return debug_1.BREAKPOINT_EDITOR_CONTRIBUTION_ID;
        }
        registerListeners() {
        ...
        getContextMenuActions(breakpoints, uri, lineNumber, column) {
            ...
            if (breakpoints.length === 1) {
                ...
                actions.push(new actions_1.Action('addConditionalBreakpoint', nls.localize('addConditionalBreakpoint', "Add Conditional Breakpoint..."), undefined, true, () => Promise.resolve(this.showBreakpointWidget(lineNumber, column))));
    ...
    class InlineBreakpointWidget {
        ...
        create(cssClass) {
            ...
            const updateSize = () => {
                const lineHeight = this.editor.getOption(45 /* lineHeight */);
            ...
            this.toDispose.push(this.editor.onDidChangeConfiguration(c => {
                if (c.hasChanged(32 /* fontSize */) || c.hasChanged(45 /* lineHeight */)) {
                    updateSize();
                }
            }));
        }
    ...
    editorExtensions_1.registerEditorContribution(BreakpointEditorContribution);
});
