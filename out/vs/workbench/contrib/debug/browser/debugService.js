    ...
    let DebugService = class DebugService {
        ...
        runTaskAndCheckErrors(root, taskId) {
            return this.runTask(root, taskId).then((taskSummary) => {
                ...
                return this.dialogService.show(severity_1.default.Warning, message, [nls.localize('debugAnyway', "Debug Anyway"), nls.localize('showErrors', "Show Errors"), nls.localize('cancel', "Cancel")], {
                    checkbox: {
