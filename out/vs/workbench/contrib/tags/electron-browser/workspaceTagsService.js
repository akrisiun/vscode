...
define(["require", "exports", "crypto", "vs/platform/files/common/files", "vs/platform/workspace/common/workspace", "vs/workbench/services/environment/common/environmentService", "vs/workbench/services/host/browser/host", "vs/platform/notification/common/notification", "vs/platform/quickinput/common/quickInput", "vs/workbench/services/textfile/common/textfiles", "vs/base/common/network", "vs/platform/workspaces/common/workspaces", "vs/nls", "vs/base/common/severity", "vs/base/common/resources", "vs/platform/instantiation/common/extensions", "vs/workbench/contrib/tags/common/workspaceTags", "vs/workbench/contrib/tags/electron-browser/workspaceTags", "vs/platform/product/common/productService"], function (require, exports, crypto, files_1, workspace_1, environmentService_1, host_1, notification_1, quickInput_1, textfiles_1, network_1, workspaces_1, nls_1, severity_1, resources_1, extensions_1, workspaceTags_1, workspaceTags_2, productService_1) {
    "use strict";
    ...
    let WorkspaceTagsService = /** @class */ (() => {
        let WorkspaceTagsService = class WorkspaceTagsService {
            ...
            getHashedRemotesFromUri(workspaceUri, stripEndingDotGit = false) {
                ...
                return this.fileService.exists(uri).then(exists => {
                    ...
                    return this.textFileService.read(uri, { acceptTextOnly: true }).then(content => workspaceTags_2.getHashedRemotesFromConfig(content.value, stripEndingDotGit), err => [] // ignore missing or binary file
                    );
                });
            }
            /* __GDPR__FRAGMENT__
        ...
        return WorkspaceTagsService;
    })();
    exports.WorkspaceTagsService = WorkspaceTagsService;
    extensions_1.registerSingleton(workspaceTags_1.IWorkspaceTagsService, WorkspaceTagsService, true);
});
