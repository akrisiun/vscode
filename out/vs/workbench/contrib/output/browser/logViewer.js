    ...
    let LogViewerInput = /** @class */ (() => {
        let LogViewerInput = class LogViewerInput extends resourceEditorInput_1.ResourceEditorInput {
            constructor(outputChannelDescriptor, textModelResolverService, textFileService, editorService, editorGroupService, fileService, labelService, filesConfigurationService) {
                super(path_1.basename(outputChannelDescriptor.file.path), path_1.dirname(outputChannelDescriptor.file.path), uri_1.URI.from({ scheme: output_1.LOG_SCHEME, path: outputChannelDescriptor.id }), undefined, textModelResolverService, textFileService, editorService, editorGroupService, fileService, labelService, filesConfigurationService);
            }
            getTypeId() {
