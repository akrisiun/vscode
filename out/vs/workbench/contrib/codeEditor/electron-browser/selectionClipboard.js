...
define(["require", "exports", "vs/base/common/async", "vs/base/common/lifecycle", "vs/base/common/platform", "vs/editor/browser/editorExtensions", "vs/editor/common/core/range", "vs/platform/clipboard/common/clipboardService", "vs/workbench/contrib/codeEditor/browser/selectionClipboard"], function (require, exports, async_1, lifecycle_1, platform, editorExtensions_1, range_1, clipboardService_1, selectionClipboard_1) {
    "use strict";
    ...
    let SelectionClipboard = class SelectionClipboard extends lifecycle_1.Disposable {
        constructor(editor, clipboardService) {
            super();
            if (platform.isLinux) {
                let isEnabled = editor.getOption(75 /* selectionClipboard */);
                this._register(editor.onDidChangeConfiguration((e) => {
                    if (e.hasChanged(75 /* selectionClipboard */)) {
                        isEnabled = editor.getOption(75 /* selectionClipboard */);
                    }
                }));
