...
define(["require", "exports", "vs/nls", "vs/base/common/actions", "vs/platform/actions/common/actions", "vs/platform/configuration/common/configuration", "vs/platform/contextkey/common/contextkey", "vs/platform/registry/common/platform", "vs/workbench/common/actions", "vs/editor/browser/services/codeEditorService", "vs/editor/browser/controller/coreCommands", "vs/editor/common/core/position", "vs/editor/common/core/selection", "vs/editor/common/controller/cursorCommon"], function (require, exports, nls, actions_1, actions_2, configuration_1, contextkey_1, platform_1, actions_3, codeEditorService_1, coreCommands_1, position_1, selection_1, cursorCommon_1) {
    ...
    let ToggleColumnSelectionAction = /** @class */ (() => {
        let ToggleColumnSelectionAction = class ToggleColumnSelectionAction extends actions_1.Action {
            ...
            async run() {
                ...
                if (codeEditor.getOption(13 /* columnSelection */)) {
                    ...
                    coreCommands_1.CoreNavigationCommands.MoveTo.runCoreEditorCommand(cursors, {
                        position: modelSelectionStart,
                        viewPosition: viewSelectionStart
                    });
                    const visibleColumn = cursorCommon_1.CursorColumns.visibleColumnFromColumn2(cursors.context.config, cursors.context.viewModel, viewPosition);
                    coreCommands_1.CoreNavigationCommands.ColumnSelect.runCoreEditorCommand(cursors, {
                    ...
                    const fromViewColumn = cursorCommon_1.CursorColumns.columnFromVisibleColumn2(cursors.context.config, cursors.context.viewModel, columnSelectData.fromViewLineNumber, columnSelectData.fromViewVisualColumn);
                    const fromPosition = cursors.context.convertViewPositionToModelPosition(columnSelectData.fromViewLineNumber, fromViewColumn);
                    const toViewColumn = cursorCommon_1.CursorColumns.columnFromVisibleColumn2(cursors.context.config, cursors.context.viewModel, columnSelectData.toViewLineNumber, columnSelectData.toViewVisualColumn);
        ...
        return ToggleColumnSelectionAction;
    })();
