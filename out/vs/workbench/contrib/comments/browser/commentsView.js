    ...
    let CommentsPanel = /** @class */ (() => {
        let CommentsPanel = class CommentsPanel extends viewPaneContainer_1.ViewPane {
            ...
            createTree() {
                ...
                this.tree = this._register(this.instantiationService.createInstance(commentsTreeViewer_1.CommentsList, this.treeLabels, this.treeContainer, { overrideStyles: { listBackground: this.getBackgroundColor() } }));
