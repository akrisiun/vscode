...
define(["require", "exports", "vs/base/common/keyCodes", "vs/base/common/lifecycle", "vs/base/common/uri", "vs/editor/contrib/suggest/suggest", "vs/nls", "vs/platform/actions/common/actions", "vs/platform/commands/common/commands", "vs/platform/contextkey/common/contextkey", "vs/platform/instantiation/common/descriptors", "vs/platform/instantiation/common/instantiation", "vs/platform/keybinding/common/keybindingsRegistry", "vs/platform/label/common/label", "vs/platform/registry/common/platform", "vs/platform/remote/common/remoteHosts", "vs/platform/workspace/common/workspace", "vs/workbench/browser/contextkeys", "vs/platform/contextkey/common/contextkeys", "vs/workbench/browser/editor", "vs/workbench/common/contributions", "vs/workbench/common/editor", "vs/workbench/common/resources", "vs/workbench/contrib/files/common/files", "vs/workbench/contrib/preferences/browser/keybindingsEditor", "vs/workbench/contrib/preferences/browser/preferencesActions", "vs/workbench/contrib/preferences/browser/preferencesEditor", "vs/workbench/contrib/preferences/browser/settingsEditor2", "vs/workbench/contrib/preferences/common/preferences", "vs/workbench/contrib/preferences/common/preferencesContribution", "vs/workbench/services/editor/common/editorService", "vs/workbench/services/environment/common/environmentService", "vs/workbench/services/extensions/common/extensions", "vs/workbench/services/preferences/common/preferences", "vs/workbench/services/preferences/common/preferencesEditorInput", "vs/workbench/browser/actions/workspaceCommands", "vs/css!./media/preferences"], function (require, exports, keyCodes_1, lifecycle_1, uri_1, suggest_1, nls, actions_1, commands_1, contextkey_1, descriptors_1, instantiation_1, keybindingsRegistry_1, label_1, platform_1, remoteHosts_1, workspace_1, contextkeys_1, contextkeys_2, editor_1, contributions_1, editor_2, resources_1, files_1, keybindingsEditor_1, preferencesActions_1, preferencesEditor_1, settingsEditor2_1, preferences_1, preferencesContribution_1, editorService_1, environmentService_1, extensions_1, preferences_2, preferencesEditorInput_1, workspaceCommands_1) {
    "use strict";
    ...
    class PreferencesEditorInputFactory {
        canSerialize(editorInput) {
            ...
            if (input.details && input.master) {
                ...
                return !!((detailsInputFactory === null || detailsInputFactory === void 0 ? void 0 : detailsInputFactory.canSerialize(input.details)) && (masterInputFactory === null || masterInputFactory === void 0 ? void 0 : masterInputFactory.canSerialize(input.master)));
            }
            return false;
        }
    ...
    let PreferencesActionsContribution = /** @class */ (() => {
        let PreferencesActionsContribution = class PreferencesActionsContribution extends lifecycle_1.Disposable {
            ...
            registerSettingsEditorActions() {
                ...
                actions_1.registerAction2(class extends actions_1.Action2 {
                    constructor() {
                        super({
                            id: preferences_1.SETTINGS_EDITOR_COMMAND_FOCUS_TOC,
    ...
    actions_1.MenuRegistry.appendMenuItem(actions_1.MenuId.MenubarFileMenu, {
        ...
        group: '5_autosave',
        order: 2,
        when: contextkeys_2.IsMacNativeContext.toNegated() // on macOS native the preferences menu is separate under the application menu
    });
});
