...
define(["require", "exports", "vs/base/browser/contextmenu", "vs/base/browser/dom", "vs/base/common/async", "vs/base/common/event", "vs/base/common/lifecycle", "vs/editor/common/core/position", "vs/editor/common/core/range", "vs/editor/common/model/textModel", "vs/nls", "vs/platform/configuration/common/configuration", "vs/platform/configuration/common/configurationRegistry", "vs/platform/contextview/browser/contextView", "vs/platform/instantiation/common/instantiation", "vs/platform/registry/common/platform", "vs/platform/telemetry/common/telemetry", "vs/platform/workspace/common/workspace", "vs/workbench/browser/parts/editor/rangeDecorations", "vs/workbench/contrib/preferences/browser/preferencesWidgets", "vs/workbench/services/preferences/common/preferences", "vs/workbench/services/preferences/common/preferencesModels", "vs/platform/markers/common/markers", "vs/workbench/services/environment/common/environmentService"], function (require, exports, contextmenu_1, dom_1, async_1, event_1, lifecycle_1, position_1, range_1, textModel_1, nls, configuration_1, configurationRegistry_1, contextView_1, instantiation_1, platform_1, telemetry_1, workspace_1, rangeDecorations_1, preferencesWidgets_1, preferences_1, preferencesModels_1, markers_1, environmentService_1) {
    "use strict";
    ...
    let EditSettingRenderer = class EditSettingRenderer extends lifecycle_1.Disposable {
        ...
        onConfigurationChanged() {
            if (!this.editor.getOption(36 /* glyphMargin */)) {
                this.editPreferenceWidgetForCursorPosition.hide();
                this.editPreferenceWidgetForMouseMove.hide();
            }
        }
        ...
        showEditPreferencesWidget(editPreferencesWidget, settings) {
            ...
            if (this.editor.getOption(36 /* glyphMargin */) && this.marginFreeFromOtherDecorations(line)) {
