...
define(["require", "exports", "vs/base/common/event", "vs/base/common/json", "vs/platform/files/common/files", "vs/platform/storage/common/storage", "vs/base/common/buffer", "vs/workbench/contrib/url/common/trustedDomains", "vs/platform/product/common/productService", "vs/platform/userDataSync/common/storageKeys"], function (require, exports, event_1, json_1, files_1, storage_1, buffer_1, trustedDomains_1, productService_1, storageKeys_1) {
    "use strict";
...
`;
    ...
    let TrustedDomainsFileSystemProvider = /** @class */ (() => {
        let TrustedDomainsFileSystemProvider = class TrustedDomainsFileSystemProvider {
            constructor(fileService, storageService, productService, storageKeysSyncRegistryService) {
        ...
        return TrustedDomainsFileSystemProvider;
    })();
