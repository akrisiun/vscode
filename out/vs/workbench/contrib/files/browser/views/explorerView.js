...
define(["require", "exports", "vs/nls", "vs/base/common/performance", "vs/base/common/decorators", "vs/workbench/contrib/files/common/files", "vs/workbench/contrib/files/browser/fileActions", "vs/workbench/common/editor", "vs/workbench/common/editor/diffEditorInput", "vs/base/browser/dom", "vs/workbench/services/layout/browser/layoutService", "vs/workbench/contrib/files/browser/views/explorerDecorationsProvider", "vs/platform/workspace/common/workspace", "vs/platform/configuration/common/configuration", "vs/platform/keybinding/common/keybinding", "vs/platform/instantiation/common/instantiation", "vs/platform/progress/common/progress", "vs/platform/contextview/browser/contextView", "vs/platform/contextkey/common/contextkey", "vs/workbench/common/resources", "vs/workbench/services/decorations/browser/decorations", "vs/platform/list/browser/listService", "vs/base/browser/dnd", "vs/workbench/services/editor/common/editorService", "vs/workbench/browser/parts/views/viewPaneContainer", "vs/platform/label/common/label", "vs/workbench/contrib/files/browser/views/explorerViewer", "vs/platform/theme/common/themeService", "vs/platform/actions/common/actions", "vs/platform/actions/browser/menuEntryActionViewItem", "vs/platform/telemetry/common/telemetry", "vs/workbench/contrib/files/common/explorerModel", "vs/base/common/errors", "vs/workbench/browser/labels", "vs/workbench/browser/parts/views/views", "vs/platform/storage/common/storage", "vs/platform/clipboard/common/clipboardService", "vs/base/common/resources", "vs/base/common/map", "vs/base/common/arrays", "vs/base/common/types", "vs/platform/files/common/files", "vs/base/common/lifecycle", "vs/base/common/event", "vs/platform/theme/common/styler", "vs/platform/theme/common/colorRegistry", "vs/workbench/common/theme", "vs/workbench/common/views", "vs/platform/opener/common/opener"], function (require, exports, nls, perf, decorators_1, files_1, fileActions_1, editor_1, diffEditorInput_1, DOM, layoutService_1, explorerDecorationsProvider_1, workspace_1, configuration_1, keybinding_1, instantiation_1, progress_1, contextView_1, contextkey_1, resources_1, decorations_1, listService_1, dnd_1, editorService_1, viewPaneContainer_1, label_1, explorerViewer_1, themeService_1, actions_1, menuEntryActionViewItem_1, telemetry_1, explorerModel_1, errors_1, labels_1, views_1, storage_1, clipboardService_1, resources_2, map_1, arrays_1, types_1, files_2, lifecycle_1, event_1, styler_1, colorRegistry_1, theme_1, views_2, opener_1) {
    "use strict";
    ...
    let ExplorerView = /** @class */ (() => {
        let ExplorerView = class ExplorerView extends viewPaneContainer_1.ViewPane {
            constructor(options, contextMenuService, viewDescriptorService, instantiationService, contextService, progressService, editorService, layoutService, keybindingService, contextKeyService, configurationService, decorationService, labelService, themeService, menuService, telemetryService, explorerService, storageService, clipboardService, fileService, openerService) {
            ...
            createTree(container) {
                ...
                this.onFocusChanged([]);
                const explorerNavigator = new listService_1.TreeResourceNavigator(this.tree);
            ...
            async selectResource(resource, reveal = this.autoReveal, retry = 0) {
                ...
                let item = this.explorerService.roots.filter(i => resources_2.isEqualOrParent(resource, i.resource, ignoreCase))
                ...
                while (item && item.resource.toString() !== resource.toString()) {
                    ...
                    item = arrays_1.first(map_1.values(item.children), i => resources_2.isEqualOrParent(resource, i.resource, ignoreCase));
                }
                if (item) {
        ...
        ExplorerView = __decorate([
            ...
            __param(2, views_2.IViewDescriptorService),
