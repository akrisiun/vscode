...
define(["require", "exports", "vs/nls", "vs/base/common/platform", "vs/base/common/extpath", "vs/base/common/path", "vs/base/common/resources", "vs/base/common/errorMessage", "vs/base/common/strings", "vs/base/common/actions", "vs/base/common/lifecycle", "vs/workbench/contrib/files/common/files", "vs/workbench/services/textfile/common/textfiles", "vs/platform/files/common/files", "vs/workbench/common/editor", "vs/platform/quickinput/common/quickInput", "vs/workbench/services/viewlet/browser/viewlet", "vs/platform/instantiation/common/instantiation", "vs/workbench/services/host/browser/host", "vs/workbench/contrib/files/browser/fileCommands", "vs/editor/common/services/resolverService", "vs/platform/configuration/common/configuration", "vs/platform/clipboard/common/clipboardService", "vs/editor/common/services/modeService", "vs/editor/common/services/modelService", "vs/platform/commands/common/commands", "vs/platform/contextkey/common/contextkey", "vs/base/common/network", "vs/platform/dialogs/common/dialogs", "vs/platform/notification/common/notification", "vs/workbench/services/editor/common/editorService", "vs/workbench/browser/parts/editor/editorCommands", "vs/base/common/arrays", "vs/workbench/contrib/files/common/explorerModel", "vs/base/common/errors", "vs/base/browser/dom", "vs/base/common/labels", "vs/workbench/services/filesConfiguration/common/filesConfigurationService", "vs/workbench/services/workingCopy/common/workingCopyService", "vs/base/common/async", "vs/workbench/services/workingCopy/common/workingCopyFileService", "vs/base/common/functional", "vs/base/common/codicons", "vs/workbench/common/views", "vs/workbench/contrib/files/common/openWith"], function (require, exports, nls, platform_1, extpath, path_1, resources, errorMessage_1, strings, actions_1, lifecycle_1, files_1, textfiles_1, files_2, editor_1, quickInput_1, viewlet_1, instantiation_1, host_1, fileCommands_1, resolverService_1, configuration_1, clipboardService_1, modeService_1, modelService_1, commands_1, contextkey_1, network_1, dialogs_1, notification_1, editorService_1, editorCommands_1, arrays_1, explorerModel_1, errors_1, dom_1, labels_1, filesConfigurationService_1, workingCopyService_1, async_1, workingCopyFileService_1, functional_1, codicons_1, views_1, openWith_1) {
    ...
    let GlobalNewUntitledFileAction = /** @class */ (() => {
    ...
    // Global Compare with
    let GlobalCompareResourcesAction = /** @class */ (() => {
        let GlobalCompareResourcesAction = class GlobalCompareResourcesAction extends actions_1.Action {
            constructor(id, label, quickInputService, editorService, notificationService) {
                super(id, label);
    ...
    let ReopenResourcesAction = /** @class */ (() => {
        let ReopenResourcesAction = class ReopenResourcesAction extends actions_1.Action {
            ...
            async run() {
                ...
                await openWith_1.openEditorWith(activeInput, undefined, options, group, this.editorService, this.configurationService, this.quickInputService);
            }
        };
        ReopenResourcesAction.ID = 'workbench.files.action.reopenWithEditor';
        ReopenResourcesAction.LABEL = nls.localize('workbench.files.action.reopenWithEditor', "Reopen With...");
        ReopenResourcesAction = __decorate([
            __param(2, quickInput_1.IQuickInputService),
            __param(3, editorService_1.IEditorService),
            __param(4, configuration_1.IConfigurationService)
        ], ReopenResourcesAction);
        return ReopenResourcesAction;
    })();
    exports.ReopenResourcesAction = ReopenResourcesAction;
    let ToggleEditorTypeCommand = /** @class */ (() => {
        let ToggleEditorTypeCommand = class ToggleEditorTypeCommand extends actions_1.Action {
            constructor(id, label, editorService) {
                super(id, label);
                this.editorService = editorService;
            }
            async run() {
                ...
                const options = activeEditorPane.options;
                const group = activeEditorPane.group;
                const overrides = openWith_1.getAllAvailableEditors(input.resource, options, group, this.editorService);
                const firstNonActiveOverride = overrides.find(([_, entry]) => !entry.active);
                if (!firstNonActiveOverride) {
                    return;
                }
                await ((_a = firstNonActiveOverride[0].open(input, options, group, firstNonActiveOverride[1].id)) === null || _a === void 0 ? void 0 : _a.override);
            }
        };
        ToggleEditorTypeCommand.ID = 'workbench.files.action.toggleEditorType';
        ToggleEditorTypeCommand.LABEL = nls.localize('workbench.files.action.toggleEditorType', "Toggle Editor Type");
        ToggleEditorTypeCommand = __decorate([
            __param(2, editorService_1.IEditorService)
        ], ToggleEditorTypeCommand);
        return ToggleEditorTypeCommand;
    })();
    exports.ToggleEditorTypeCommand = ToggleEditorTypeCommand;
    let ToggleAutoSaveAction = /** @class */ (() => {
    ...
    let SaveAllInGroupAction = /** @class */ (() => {
    ...
    let ShowActiveFileInExplorer = /** @class */ (() => {
    ...
    let CollapseExplorerView = /** @class */ (() => {
    ...
    let ShowOpenedFileInNewWindow = /** @class */ (() => {
    ...
    let CompareWithClipboardAction = /** @class */ (() => {
