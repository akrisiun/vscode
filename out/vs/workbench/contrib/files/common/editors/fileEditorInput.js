...
define(["require", "exports", "vs/nls", "vs/workbench/common/editor", "vs/workbench/common/editor/binaryEditorModel", "vs/platform/files/common/files", "vs/workbench/services/textfile/common/textfiles", "vs/platform/instantiation/common/instantiation", "vs/base/common/lifecycle", "vs/editor/common/services/resolverService", "vs/workbench/contrib/files/common/files", "vs/platform/label/common/label", "vs/workbench/services/filesConfiguration/common/filesConfigurationService", "vs/workbench/services/editor/common/editorService", "vs/workbench/services/editor/common/editorGroupsService", "vs/base/common/resources", "vs/base/common/event"], function (require, exports, nls_1, editor_1, binaryEditorModel_1, files_1, textfiles_1, instantiation_1, lifecycle_1, resolverService_1, files_2, label_1, filesConfigurationService_1, editorService_1, editorGroupsService_1, resources_1, event_1) {
     ...
     */
    let FileEditorInput = /** @class */ (() => {
        let FileEditorInput = class FileEditorInput extends editor_1.TextResourceEditorInput {
            constructor(resource, preferredEncoding, preferredMode, instantiationService, textFileService, textModelResolverService, labelService, fileService, filesConfigurationService, editorService, editorGroupService) {
            ...
            onDidCreateTextFileModel(model) {
                ...
                if (resources_1.isEqual(model.resource, this.resource)) {
                    this.model = model;
            ...
            getViewStateFor(group) {
                for (const editorPane of this.editorService.visibleEditorPanes) {
                    if (editorPane.group.id === group && resources_1.isEqual(editorPane.input.resource, this.resource)) {
