...
define(["require", "exports", "vs/nls", "vs/platform/workspace/common/workspace", "vs/base/common/platform", "vs/base/common/network", "vs/platform/notification/common/notification", "vs/platform/electron/node/electron", "vs/platform/keybinding/common/keybindingsRegistry", "vs/editor/common/editorContextKeys", "vs/base/common/keyCodes", "vs/workbench/contrib/files/browser/files", "vs/platform/list/browser/listService", "vs/workbench/services/editor/common/editorService", "vs/workbench/contrib/files/electron-browser/fileCommands", "vs/platform/actions/common/actions", "vs/workbench/common/resources", "vs/workbench/contrib/files/browser/fileActions.contribution", "vs/workbench/contrib/files/common/files"], function (require, exports, nls, workspace_1, platform_1, network_1, notification_1, electron_1, keybindingsRegistry_1, editorContextKeys_1, keyCodes_1, files_1, listService_1, editorService_1, fileCommands_1, actions_1, resources_1, fileActions_contribution_1, files_2) {
    ...
    keybindingsRegistry_1.KeybindingsRegistry.registerCommandAndKeybindingRule({
        ...
        handler: (accessor, resource) => {
            const resources = files_1.getMultiSelectedResources(resource, accessor.get(listService_1.IListService), accessor.get(editorService_1.IEditorService), accessor.get(files_2.IExplorerService));
    ...
    const revealInOsCommand = {
        id: REVEAL_IN_OS_COMMAND_ID,
        title: platform_1.isWindows ? nls.localize('revealInWindows', "Reveal in File Explorer") : platform_1.isMacintosh ? nls.localize('revealInMac', "Reveal in Finder") : nls.localize('openContainer', "Open Containing Folder")
    };
    ...
    fileActions_contribution_1.appendToCommandPalette(REVEAL_IN_OS_COMMAND_ID, { value: REVEAL_IN_OS_LABEL, original: platform_1.isWindows ? 'Reveal in File Explorer' : platform_1.isMacintosh ? 'Reveal in Finder' : 'Open Containing Folder' }, category, resources_1.ResourceContextKey.Scheme.isEqualTo(network_1.Schemas.file));
});
