...
define(["require", "exports", "vs/base/common/arrays", "vs/base/common/decorators", "vs/base/common/lifecycle", "vs/base/common/map", "vs/base/common/resources", "vs/platform/editor/common/editor", "vs/platform/instantiation/common/extensions", "vs/platform/instantiation/common/instantiation", "vs/workbench/contrib/webview/browser/webview", "vs/workbench/services/editor/common/editorGroupsService", "vs/workbench/services/editor/common/editorService", "./webviewEditorInput", "vs/base/common/lazy"], function (require, exports, arrays_1, decorators_1, lifecycle_1, map_1, resources_1, editor_1, extensions_1, instantiation_1, webview_1, editorGroupsService_1, editorService_1, webviewEditorInput_1, lazy_1) {
    "use strict";
    ...
    let WebviewEditorService = class WebviewEditorService {
        constructor(_editorService, _editorGroupService, _webviewService) {
        ...
        createWebview(id, viewType, title, showOptions, options, extension) {
            ...
            const webviewInput = new webviewEditorInput_1.WebviewInput(id, viewType, title, webview);
