...
define(["require", "exports", "vs/base/common/uri", "vs/base/common/uuid", "vs/platform/extensions/common/extensions", "./webviewEditorInput", "./webviewEditorService"], function (require, exports, uri_1, uuid_1, extensions_1, webviewEditorInput_1, webviewEditorService_1) {
    "use strict";
    ...
    let WebviewEditorInputFactory = class WebviewEditorInputFactory {
        ...
        deserialize(_instantiationService, serializedEditorInput) {
            ...
            return this._webviewService.reviveWebview(data.id || uuid_1.generateUuid(), data.viewType, data.title, data.iconPath, data.state, data.options, data.extensionLocation ? {
