...
define(["require", "exports", "vs/base/browser/dom", "vs/base/common/async", "vs/base/common/event", "vs/base/common/functional", "vs/base/common/lifecycle", "vs/base/common/platform", "vs/platform/configuration/common/configuration", "vs/platform/environment/common/environment", "vs/platform/files/common/files", "vs/platform/instantiation/common/instantiation", "vs/platform/remote/common/tunnel", "vs/platform/telemetry/common/telemetry", "vs/workbench/contrib/webview/browser/baseWebviewElement", "vs/workbench/contrib/webview/common/portMapping", "vs/workbench/contrib/webview/common/resourceLoader", "vs/workbench/contrib/webview/electron-browser/webviewProtocols", "vs/workbench/services/environment/common/environmentService", "../browser/webviewFindWidget"], function (require, exports, dom_1, async_1, event_1, functional_1, lifecycle_1, platform_1, configuration_1, environment_1, files_1, instantiation_1, tunnel_1, telemetry_1, baseWebviewElement_1, portMapping_1, resourceLoader_1, webviewProtocols_1, environmentService_1, webviewFindWidget_1) {
    "use strict";
    ...
    class WebviewProtocolProvider extends lifecycle_1.Disposable {
        constructor(handle, getExtensionLocation, getLocalResourceRoots, fileService) {
            super();
            ...
            this._register(handle.onFirstLoad(contents => {
                try {
                    webviewProtocols_1.registerFileProtocol(contents, resourceLoader_1.WebviewResourceScheme, fileService, getExtensionLocation(), getLocalResourceRoots);
                    this._resolve();
                }
                catch (_a) {
                    this._reject();
    ...
    class WebviewKeyboardHandler {
        ...
        add(webviewHandle) {
            ...
            disposables.add(dom_1.addDisposableListener(webviewHandle.webview, 'ipc-message', (event) => {
        ...
        setIgnoreMenuShortcutsForWebview(webview, value) {
            if (this.shouldToggleMenuShortcutsEnablement) {
                ...
                if (!(contents === null || contents === void 0 ? void 0 : contents.isDestroyed())) {
                    contents === null || contents === void 0 ? void 0 : contents.setIgnoreMenuShortcuts(value);
                }
            }
        }
    }
    let ElectronWebviewBasedWebview = /** @class */ (() => {
        let ElectronWebviewBasedWebview = class ElectronWebviewBasedWebview extends baseWebviewElement_1.BaseWebview {
            constructor(id, options, contentOptions, _webviewThemeDataProvider, instantiationService, fileService, tunnelService, telemetryService, environementService, workbenchEnvironmentService, configurationService) {
                ...
                this._protocolProvider = new WebviewProtocolProvider(webviewAndContents, () => { var _a; return (_a = this.extension) === null || _a === void 0 ? void 0 : _a.location; }, () => (this.content.options.localResourceRoots || []), fileService);
            ...
            static getWebviewKeyboardHandler(configService) {
            ...
            async postMessage(channel, data) {
                var _a;
                await Promise.all([
        ...
        return ElectronWebviewBasedWebview;
    })();
