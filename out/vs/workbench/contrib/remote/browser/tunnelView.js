    ...
    let TunnelPanel = /** @class */ (() => {
        let TunnelPanel = class TunnelPanel extends viewPaneContainer_1.ViewPane {
            ...
            renderBody(container) {
                ...
                const navigator = this._register(new listService_1.TreeResourceNavigator(this.tree, { openOnFocus: false, openOnSelection: false }));
                this._register(event_1.Event.debounce(navigator.onDidOpenResource, (last, event) => event, 75, true)(e => {
