...
define(["require", "exports", "vs/nls", "vs/base/browser/dom", "vs/base/common/actions", "vs/base/browser/ui/actionbar/actionbar", "vs/platform/theme/common/themeService", "vs/platform/theme/common/styler", "vs/platform/contextview/browser/contextView", "vs/workbench/common/theme", "vs/platform/theme/common/colorRegistry", "vs/workbench/services/remote/common/remoteExplorerService", "vs/base/common/strings", "vs/base/common/types", "vs/workbench/services/environment/common/environmentService", "vs/platform/storage/common/storage"], function (require, exports, nls, dom, actions_1, actionbar_1, themeService_1, styler_1, contextView_1, theme_1, colorRegistry_1, remoteExplorerService_1, strings_1, types_1, environmentService_1, storage_1) {
    ...
    let SwitchRemoteViewItem = /** @class */ (() => {
        ...
        return SwitchRemoteViewItem;
    })();
    exports.SwitchRemoteViewItem = SwitchRemoteViewItem;
    let SwitchRemoteAction = /** @class */ (() => {
