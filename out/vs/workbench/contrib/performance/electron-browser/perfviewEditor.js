...
define(["require", "exports", "vs/nls", "vs/base/common/uri", "vs/workbench/common/editor/resourceEditorInput", "vs/editor/common/services/resolverService", "vs/platform/lifecycle/common/lifecycle", "vs/editor/common/services/modeService", "vs/platform/instantiation/common/instantiation", "vs/editor/common/services/modelService", "vs/workbench/services/timer/electron-browser/timerService", "vs/base/common/strings", "vs/workbench/services/extensions/common/extensions", "vs/base/common/performance", "vs/base/common/lifecycle", "vs/editor/browser/services/codeEditorService", "vs/workbench/contrib/codeEditor/browser/toggleWordWrap", "vs/base/common/arrays", "vs/platform/product/common/product", "vs/workbench/services/textfile/common/textfiles", "vs/workbench/services/editor/common/editorService", "vs/workbench/services/editor/common/editorGroupsService", "vs/platform/files/common/files", "vs/platform/label/common/label", "vs/workbench/services/filesConfiguration/common/filesConfigurationService"], function (require, exports, nls_1, uri_1, resourceEditorInput_1, resolverService_1, lifecycle_1, modeService_1, instantiation_1, modelService_1, timerService_1, strings_1, extensions_1, perf, lifecycle_2, codeEditorService_1, toggleWordWrap_1, arrays_1, product_1, textfiles_1, editorService_1, editorGroupsService_1, files_1, label_1, filesConfigurationService_1) {
    "use strict";
    ...
    let PerfviewInput = /** @class */ (() => {
        let PerfviewInput = class PerfviewInput extends resourceEditorInput_1.ResourceEditorInput {
            constructor(textModelResolverService, textFileService, editorService, editorGroupService, fileService, labelService, filesConfigurationService) {
                super(nls_1.localize('name', "Startup Performance"), undefined, PerfviewInput.Uri, undefined, textModelResolverService, textFileService, editorService, editorGroupService, fileService, labelService, filesConfigurationService);
            }
            getTypeId() {
