...
define(["require", "exports", "vs/base/common/arrays", "vs/base/common/event", "vs/base/common/lazy", "vs/base/common/lifecycle", "vs/base/common/resources", "vs/base/common/uuid", "vs/nls", "vs/platform/configuration/common/configuration", "vs/platform/contextkey/common/contextkey", "vs/platform/editor/common/editor", "vs/platform/files/common/files", "vs/platform/instantiation/common/instantiation", "vs/platform/quickinput/common/quickInput", "vs/platform/theme/common/colorRegistry", "vs/platform/theme/common/themeService", "vs/workbench/common/editor", "vs/workbench/common/editor/diffEditorInput", "vs/workbench/contrib/customEditor/common/customEditor", "vs/workbench/contrib/customEditor/common/customEditorModelManager", "vs/workbench/contrib/files/common/editors/fileEditorInput", "vs/workbench/contrib/files/common/openWith", "vs/workbench/contrib/webview/browser/webview", "vs/workbench/services/editor/common/editorAssociationsSetting", "vs/workbench/services/editor/common/editorGroupsService", "vs/workbench/services/editor/common/editorService", "../common/contributedCustomEditors", "./customEditorInput"], function (require, exports, arrays_1, event_1, lazy_1, lifecycle_1, resources_1, uuid_1, nls, configuration_1, contextkey_1, editor_1, files_1, instantiation_1, quickInput_1, colorRegistry, themeService_1, editor_2, diffEditorInput_1, customEditor_1, customEditorModelManager_1, fileEditorInput_1, openWith_1, webview_1, editorAssociationsSetting_1, editorGroupsService_1, editorService_1, contributedCustomEditors_1, customEditorInput_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.CustomEditorContribution = exports.CustomEditorService = void 0;
    let CustomEditorService = /** @class */ (() => {
        let CustomEditorService = class CustomEditorService extends lifecycle_1.Disposable {
            constructor(contextKeyService, fileService, configurationService, editorService, editorGroupService, instantiationService, quickInputService, webviewService) {
                super();
                ...
                this._contributedEditors = this._register(new contributedCustomEditors_1.ContributedCustomEditors());
                ...
                return new Promise(resolve => {
                    ...
                    picker.onDidTriggerItemButton(e => {
                        ...
                        if (pick) {
                            ...
                            const currentAssociations = [...this.configurationService.getValue(editorAssociationsSetting_1.customEditorsAssociationsSettingId)];
                            // First try updating existing association
                            for (let i = 0; i < currentAssociations.length; ++i) {
                                const existing = currentAssociations[i];
                                if (existing.filenamePattern === newAssociation.filenamePattern) {
                                    currentAssociations.splice(i, 1, newAssociation);
                                    this.configurationService.updateValue(editorAssociationsSetting_1.customEditorsAssociationsSettingId, currentAssociations);
                                    return;
                                }
                            }
            ...
            async openWith(resource, viewType, options, group) {
                if (viewType === contributedCustomEditors_1.defaultCustomEditor.id) {
                    ...
                    return this.openEditorForResource(resource, fileEditorInput, Object.assign(Object.assign({}, options), { ignoreOverrides: true }), group);
                }
            ...
            createInput(resource, viewType, group, options) {
                ...
                const webview = new lazy_1.Lazy(() => {
                    return this.webviewService.createWebviewOverlay(id, { customClasses: options === null || options === void 0 ? void 0 : options.customClasses }, {});
                });
            ...
            async tryRevealExistingEditorForResourceInGroup(resource, viewType, options, group) {
                ...
                const targetGroup = group || this.editorGroupService.activeGroup;
                const newEditor = await this.openEditorForResource(resource, editorToUse.editor, Object.assign(Object.assign({}, options), { ignoreOverrides: true }), targetGroup);
    ...
    let CustomEditorContribution = /** @class */ (() => {
        let CustomEditorContribution = class CustomEditorContribution extends lifecycle_1.Disposable {
            constructor(editorService, customEditorService) {
                ...
                this._register(this.editorService.overrideOpenEditor({
                    ...
                    getEditorOverrides: (resource, _options, group) => {
                        ...
                        return [
                            Object.assign(Object.assign({}, openWith_1.defaultEditorOverrideEntry), { active: currentEditor instanceof fileEditorInput_1.FileEditorInput }),
            ...
            onEditorOpening(editor, options, group, id) {
                if (editor instanceof customEditorInput_1.CustomEditorInput) {
                ...
                if (id) {
                    if (editor instanceof fileEditorInput_1.FileEditorInput && id === contributedCustomEditors_1.defaultCustomEditor.id) {
                        return undefined;
                    }
                    return {
                        override: this.customEditorService.openWith(resource, id, Object.assign(Object.assign({}, options), { ignoreOverrides: true }), group)
                    };
                }
            ...
            onResourceEditorOpening(resource, editor, options, group) {
                ...
                if (existingEditorForResource) {
                    ...
                    return {
                        override: this.editorService.openEditor(existingEditorForResource, Object.assign(Object.assign({}, options), { ignoreOverrides: true, activation: (options === null || options === void 0 ? void 0 : options.preserveFocus) ? editor_1.EditorActivation.RESTORE : undefined }), group)
                    };
                }
