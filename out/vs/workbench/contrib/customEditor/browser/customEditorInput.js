...
define(["require", "exports", "vs/base/common/decorators", "vs/base/common/event", "vs/base/common/network", "vs/base/common/path", "vs/base/common/resources", "vs/platform/dialogs/common/dialogs", "vs/platform/label/common/label", "vs/workbench/contrib/webview/browser/webviewWorkbenchService", "vs/workbench/services/textfile/browser/textFileService"], function (require, exports, decorators_1, event_1, network_1, path_1, resources_1, dialogs_1, label_1, webviewWorkbenchService_1, textFileService_1) {
    "use strict";
    ...
    let CustomFileEditorInput = class CustomFileEditorInput extends webviewWorkbenchService_1.LazilyResolvedWebviewEditorInput {
        constructor(resource, viewType, id, webview, webviewWorkbenchService, dialogService, labelService) {
    ...
    CustomFileEditorInput = __decorate([
        __param(4, webviewWorkbenchService_1.IWebviewWorkbenchService),
