...
define(["require", "exports", "vs/nls", "vs/base/browser/dom", "vs/platform/registry/common/platform", "vs/base/common/actions", "vs/workbench/services/viewlet/browser/viewlet", "vs/workbench/browser/composite", "vs/platform/instantiation/common/instantiation", "vs/workbench/browser/actions/layoutActions", "vs/platform/telemetry/common/telemetry", "vs/workbench/services/layout/browser/layoutService", "vs/platform/theme/common/themeService", "vs/workbench/services/editor/common/editorGroupsService", "vs/platform/storage/common/storage", "vs/base/common/types", "vs/platform/contextview/browser/contextView", "vs/workbench/services/extensions/common/extensions", "vs/platform/workspace/common/workspace", "vs/platform/configuration/common/configuration", "vs/workbench/browser/panecomposite", "vs/base/browser/ui/actionbar/actionbar"], function (require, exports, nls, DOM, platform_1, actions_1, viewlet_1, composite_1, instantiation_1, layoutActions_1, telemetry_1, layoutService_1, themeService_1, editorGroupsService_1, storage_1, types_1, contextView_1, extensions_1, workspace_1, configuration_1, panecomposite_1, actionbar_1) {
    "use strict";
    ...
    class ViewletDescriptor extends composite_1.CompositeDescriptor {
        constructor(ctor, id, name, cssClass, order, iconUrl) {
            super(ctor, id, name, cssClass, order, id);
            this.iconUrl = iconUrl;
        }
        static create(ctor, id, name, cssClass, order, iconUrl) {
            return new ViewletDescriptor(ctor, id, name, cssClass, order, iconUrl);
        }
    }
