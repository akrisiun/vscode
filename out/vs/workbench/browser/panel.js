...
define(["require", "exports", "vs/platform/registry/common/platform", "vs/workbench/browser/composite", "vs/base/common/types", "vs/workbench/browser/panecomposite"], function (require, exports, platform_1, composite_1, types_1, panecomposite_1) {
    ...
    exports.Extensions = exports.PanelRegistry = exports.PanelDescriptor = exports.PaneCompositePanel = exports.Panel = void 0;
    class Panel extends composite_1.Composite {
    }
    exports.Panel = Panel;
    class PaneCompositePanel extends panecomposite_1.PaneComposite {
    }
    exports.PaneCompositePanel = PaneCompositePanel;
    /**
    ...
    class PanelDescriptor extends composite_1.CompositeDescriptor {
        static create(ctor, id, name, cssClass, order, _commandId) {
            return new PanelDescriptor(ctor, id, name, cssClass, order, _commandId);
        }
