...
define(["require", "exports", "vs/nls", "vs/platform/registry/common/platform", "vs/base/common/actions", "vs/workbench/services/editor/common/editorGroupsService", "vs/workbench/services/panel/common/panelService", "vs/workbench/services/layout/browser/layoutService", "vs/workbench/services/viewlet/browser/viewlet", "vs/platform/actions/common/actions", "vs/workbench/common/actions"], function (require, exports, nls, platform_1, actions_1, editorGroupsService_1, panelService_1, layoutService_1, viewlet_1, actions_2, actions_3) {
    ...
    let BaseNavigationAction = /** @class */ (() => {
    ...
    function findVisibleNeighbour(layoutService, part, next) {
        const neighbour = part === "workbench.parts.editor" /* EDITOR_PART */ ? (next ? "workbench.parts.statusbar" /* STATUSBAR_PART */ : "workbench.parts.panel" /* PANEL_PART */) : part === "workbench.parts.statusbar" /* STATUSBAR_PART */ ? (next ? "workbench.parts.sidebar" /* SIDEBAR_PART */ : "workbench.parts.editor" /* EDITOR_PART */) :
            part === "workbench.parts.sidebar" /* SIDEBAR_PART */ ? (next ? "workbench.parts.panel" /* PANEL_PART */ : "workbench.parts.statusbar" /* STATUSBAR_PART */) : part === "workbench.parts.panel" /* PANEL_PART */ ? (next ? "workbench.parts.editor" /* EDITOR_PART */ : "workbench.parts.sidebar" /* SIDEBAR_PART */) : "workbench.parts.editor" /* EDITOR_PART */;
    ...
    function focusNextOrPreviousPart(layoutService, next) {
        const currentlyFocusedPart = layoutService.hasFocus("workbench.parts.editor" /* EDITOR_PART */) ? "workbench.parts.editor" /* EDITOR_PART */ : layoutService.hasFocus("workbench.parts.statusbar" /* STATUSBAR_PART */) ? "workbench.parts.statusbar" /* STATUSBAR_PART */ :
            layoutService.hasFocus("workbench.parts.sidebar" /* SIDEBAR_PART */) ? "workbench.parts.sidebar" /* SIDEBAR_PART */ : layoutService.hasFocus("workbench.parts.panel" /* PANEL_PART */) ? "workbench.parts.panel" /* PANEL_PART */ : undefined;
    ...
    let FocusNextPart = /** @class */ (() => {
        ...
        return FocusNextPart;
    })();
    exports.FocusNextPart = FocusNextPart;
    let FocusPreviousPart = /** @class */ (() => {
