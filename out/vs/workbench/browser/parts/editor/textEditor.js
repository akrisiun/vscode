...
define(["require", "exports", "vs/nls", "vs/base/common/objects", "vs/base/common/event", "vs/base/common/types", "vs/editor/browser/widget/codeEditorWidget", "vs/workbench/browser/parts/editor/baseEditor", "vs/platform/storage/common/storage", "vs/platform/instantiation/common/instantiation", "vs/platform/telemetry/common/telemetry", "vs/platform/theme/common/themeService", "vs/editor/common/services/textResourceConfigurationService", "vs/editor/browser/editorBrowser", "vs/workbench/services/editor/common/editorGroupsService", "vs/workbench/services/editor/common/editorService"], function (require, exports, nls_1, objects_1, event_1, types_1, codeEditorWidget_1, baseEditor_1, storage_1, instantiation_1, telemetry_1, themeService_1, textResourceConfigurationService_1, editorBrowser_1, editorGroupsService_1, editorService_1) {
    "use strict";
        ...
        let BaseTextEditor = class BaseTextEditor extends baseEditor_1.BaseEditor {
            ...
            computeAriaLabel() {
                ...
                if (ariaLabel && this.group && this.editorGroupService.count > 1) {
                    ariaLabel = nls_1.localize('editorLabelWithGroup', "{0}, {1}", ariaLabel, this.group.ariaLabel);
                }
                return ariaLabel;
            }
            ...
            moveTextEditorViewState(source, target) {
