        ...
        let TabsTitleControl = class TabsTitleControl extends titleControl_1.TitleControl {
            ...
            computeTabLabels() {
                ...
                const labels = this.group.editors.map(editor => ({
                    ...
                    ariaLabel: editor.isReadonly() ? nls_1.localize('readonlyEditor', "{0} readonly", editor.getTitle(0 /* SHORT */)) : editor.getTitle(0 /* SHORT */)
                }));
            ...
            redrawLabel(editor, tabContainer, tabLabelWidget, tabLabel) {
                ...
                // Label
                tabLabelWidget.setResource({ name, description, resource: editor_1.toResource(editor, { supportSideBySide: editor_1.SideBySideEditor.BOTH }) }, { title, extraClasses: ['tab-label'], italic: !this.group.isPinned(editor) });
                // Tests helper
                const resource = editor_1.toResource(editor, { supportSideBySide: editor_1.SideBySideEditor.MASTER });
                if (resource) {
