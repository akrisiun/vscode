        ...
        let EditorGroupView = class EditorGroupView extends themeService_1.Themable {
            ...
            async doOpenEditor(editor, options) {
                ...
                const openEditorOptions = {
                    ...
                    pinned: !this.accessor.partOptions.enablePreview || editor.isDirty() || ((_a = options === null || options === void 0 ? void 0 : options.pinned) !== null && _a !== void 0 ? _a : typeof (options === null || options === void 0 ? void 0 : options.index) === 'number'),
            ...
            async doHandleDirtyClosing(editor) {
                ...
                if (editor instanceof editor_1.SideBySideEditorInput && this._group.contains(editor.master)) {
                ...
                if (this.accessor.groups.some(groupView => {
                    ...
                    if (editor instanceof editor_1.SideBySideEditorInput && otherGroup.contains(editor.master)) {
            ...
            getEditorsToClose(editors) {
                ...
                let editorsToClose = this._group.getEditors(hasDirection ? 1 /* SEQUENTIAL */ : 0 /* MOST_RECENTLY_ACTIVE */); // in MRU order only if direction is not specified
            ...
            async closeAllEditors() {
                ...
                // Check for dirty and veto
                const editors = this._group.getEditors(0 /* MOST_RECENTLY_ACTIVE */);
                const veto = await this.handleDirtyClosing(editors.slice(0));
                if (veto) {
                    return;
                }
