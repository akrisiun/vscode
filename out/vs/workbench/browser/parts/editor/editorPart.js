    ...
    let EditorPart = /** @class */ (() => {
        let EditorPart = class EditorPart extends part_1.Part {
            ...
            createContentArea(parent, options) {
                ...
                dnd_1.CompositeDragAndDropObserver.INSTANCE.registerTarget(this.element, {
                    onDragOver: e => {
