 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "vs/workbench/browser/composite", "vs/workbench/common/editor", "vs/base/common/map", "vs/base/common/uri", "vs/base/common/event", "vs/base/common/types", "vs/workbench/browser/parts/editor/editor", "vs/base/common/resources", "vs/base/common/platform", "vs/base/common/extpath"], function (require, exports, composite_1, editor_1, map_1, uri_1, event_1, types_1, editor_2, resources_1, platform_1, extpath_1) {
    "use strict";
        ...
        moveEditorState(source, target) {
            ...
            for (const cacheKey of cacheKeys) {
                ...
                if (source.toString() === resource.toString()) {
                    ...
                    const index = extpath_1.indexOfPath(resource.path, source.path, !platform_1.isLinux);
