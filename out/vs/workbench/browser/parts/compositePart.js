    ...
    class CompositePart extends part_1.Part {
        ...
        createComposite(id, isActive) {
            ...
            if (compositeDescriptor) {
                const compositeProgressIndicator = this.instantiationService.createInstance(progressIndicator_1.CompositeProgressIndicator, this.progressBar, compositeDescriptor.id, isActive);
