    ...
    let TreeView = /** @class */ (() => {
        let TreeView = class TreeView extends lifecycle_1.Disposable {
            ...
            createTree() {
                ...
                const treeNavigator = new listService_1.TreeResourceNavigator(this.tree, { openOnFocus: false, openOnSelection: false });
