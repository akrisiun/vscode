    ...
    let ViewsService = /** @class */ (() => {
        let ViewsService = class ViewsService extends lifecycle_1.Disposable {
                        ...
                        constructor() {
                            super({
                                ...
                                title: {
                                    ...
                                    value: nls_1.localize('resetViewLocation', "Reset View Location")
                                },
                                menu: [{
            ...
            getProgressIndicator(id) {
                ...
                const view = (_b = (_a = this.viewPaneContainers.get(viewContainer.id)) === null || _a === void 0 ? void 0 : _a.viewPaneContainer) === null || _b === void 0 ? void 0 : _b.getView(id);
            ...
            registerPanel(viewContainer) {
                var _a;
                const that = this;
                let PaneContainerPanel = /** @class */ (() => {
                    let PaneContainerPanel = class PaneContainerPanel extends panel_1.PaneCompositePanel {
                    ...
                    return PaneContainerPanel;
                })();
                platform_1.Registry.as(panel_1.Extensions.Panels).registerPanel(panel_1.PanelDescriptor.create(PaneContainerPanel, viewContainer.id, viewContainer.name, undefined, viewContainer.order, (_a = viewContainer.focusCommand) === null || _a === void 0 ? void 0 : _a.id));
            }
            ...
            registerViewlet(viewContainer) {
                const that = this;
                let PaneContainerViewlet = /** @class */ (() => {
                    ...
                    return PaneContainerViewlet;
                })();
                platform_1.Registry.as(viewlet_2.Extensions.Viewlets).registerViewlet(viewlet_2.ViewletDescriptor.create(PaneContainerViewlet, viewContainer.id, viewContainer.name, types_1.isString(viewContainer.icon) ? viewContainer.icon : undefined, viewContainer.order, viewContainer.icon instanceof uri_1.URI ? viewContainer.icon : undefined));
            }
