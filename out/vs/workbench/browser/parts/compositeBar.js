...
define(["require", "exports", "vs/nls", "vs/base/common/errors", "vs/base/common/arrays", "vs/base/common/lifecycle", "vs/platform/instantiation/common/instantiation", "vs/base/browser/ui/actionbar/actionbar", "vs/workbench/browser/parts/compositeBarActions", "vs/base/browser/dom", "vs/base/browser/mouseEvent", "vs/platform/contextview/browser/contextView", "vs/base/browser/ui/widget", "vs/base/common/types", "vs/base/common/event", "vs/workbench/browser/dnd"], function (require, exports, nls, errors_1, arrays, lifecycle_1, instantiation_1, actionbar_1, compositeBarActions_1, dom_1, mouseEvent_1, contextView_1, widget_1, types_1, event_1, dnd_1) {
    ...
    class CompositeDragAndDrop {
        constructor(viewDescriptorService, targetContainerLocation, openComposite, moveComposite) {
            ...
            create(parent) {
                ...
                this._register(dnd_1.CompositeDragAndDropObserver.INSTANCE.registerTarget(parent, {
                    onDragOver: (e) => {
                        ...
                        if (e.eventData.target && dom_1.isAncestor(e.eventData.target, actionBarDiv)) {
                            dom_1.toggleClass(parent, 'dragged-over', false);
                            return;
                        }
                        ...
                        dom_1.toggleClass(parent, 'dragged-over', validDropTarget);
                    },
                    onDragLeave: (e) => {
                        dom_1.toggleClass(parent, 'dragged-over', false);
                    },
