    ...
    let ResourceLabelWidget = /** @class */ (() => {
        let ResourceLabelWidget = class ResourceLabelWidget extends iconLabel_1.IconLabel {
            ...
            setResource(label, options = Object.create(null)) {
                ...
                const isMasterDetail = (label === null || label === void 0 ? void 0 : label.resource) && !uri_1.URI.isUri(label.resource);
                if (!isMasterDetail && (resource === null || resource === void 0 ? void 0 : resource.scheme) === network_1.Schemas.untitled) {
            ...
            render(clearIconCache) {
                ...
                const iconLabelOptions = {
                    ...
                    extraClasses: [],
                    separator: (_d = this.options) === null || _d === void 0 ? void 0 : _d.separator,
                    domId: (_e = this.options) === null || _e === void 0 ? void 0 : _e.domId
                };
                const resource = toResource(this.label);
