...
define(["require", "exports", "vs/workbench/services/workspaces/common/workspaceEditing", "vs/nls", "vs/platform/workspace/common/workspace", "vs/workbench/services/configuration/common/jsonEditing", "vs/platform/workspaces/common/workspaces", "vs/platform/storage/common/storage", "vs/workbench/services/extensions/common/extensions", "vs/workbench/services/backup/common/backup", "vs/platform/commands/common/commands", "vs/base/common/resources", "vs/platform/notification/common/notification", "vs/platform/files/common/files", "vs/workbench/services/environment/common/environmentService", "vs/platform/lifecycle/common/lifecycle", "vs/platform/dialogs/common/dialogs", "vs/platform/configuration/common/configuration", "vs/platform/instantiation/common/extensions", "vs/platform/label/common/label", "vs/workbench/services/textfile/common/textfiles", "vs/workbench/services/host/browser/host", "vs/workbench/services/workspaces/browser/abstractWorkspaceEditingService", "vs/platform/electron/node/electron", "vs/base/common/platform", "vs/base/common/labels"], function (require, exports, workspaceEditing_1, nls, workspace_1, jsonEditing_1, workspaces_1, storage_1, extensions_1, backup_1, commands_1, resources_1, notification_1, files_1, environmentService_1, lifecycle_1, dialogs_1, configuration_1, extensions_2, label_1, textfiles_1, host_1, abstractWorkspaceEditingService_1, electron_1, platform_1, labels_1) {
    ...
    let NativeWorkspaceEditingService = class NativeWorkspaceEditingService extends abstractWorkspaceEditingService_1.AbstractWorkspaceEditingService {
        ...
        async saveUntitedBeforeShutdown(reason) {
            ...
            const { choice } = await this.dialogService.show(notification_1.Severity.Warning, message, buttons.map(button => button.label), { detail, cancelId });
        ...
        async isValidTargetWorkspacePath(path) {
            ...
            if (windows.some(window => !!window.workspace && resources_1.isEqual(window.workspace.configPath, path))) {
                await this.dialogService.show(notification_1.Severity.Info, nls.localize('workspaceOpenedMessage', "Unable to save workspace '{0}'", resources_1.basename(path)), [nls.localize('ok', "OK")], {
