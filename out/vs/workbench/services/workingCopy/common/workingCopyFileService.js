...
define(["require", "exports", "vs/platform/instantiation/common/instantiation", "vs/platform/instantiation/common/extensions", "vs/base/common/event", "vs/base/common/arrays", "vs/base/common/lifecycle", "vs/platform/files/common/files", "vs/base/common/cancellation", "vs/workbench/services/workingCopy/common/workingCopyService", "vs/base/common/resources", "vs/workbench/services/workingCopy/common/workingCopyFileOperationParticipant"], function (require, exports, instantiation_1, extensions_1, event_1, arrays_1, lifecycle_1, files_1, cancellation_1, workingCopyService_1, resources_1, workingCopyFileOperationParticipant_1) {
    "use strict";
    ...
    let WorkingCopyFileService = /** @class */ (() => {
        let WorkingCopyFileService = class WorkingCopyFileService extends lifecycle_1.Disposable {
            constructor(fileService, workingCopyService, instantiationService) {
                super();
                ...
                this.registerWorkingCopyProvider(resource => {
                    return this.workingCopyService.workingCopies.filter(workingCopy => {
                        if (this.fileService.canHandleResource(resource)) {
                            ...
                            // path structure
                            return resources_1.isEqualOrParent(workingCopy.resource, resource);
                        }
                        return resources_1.isEqual(workingCopy.resource, resource);
                    });
                });
            }
