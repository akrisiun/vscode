            ...
            onWillRunWorkingCopyFileOperation(e) {
                ...
                if (source && (e.operation === 3 /* COPY */ || e.operation === 2 /* MOVE */)) {
                    ...
                    for (const model of this.models) {
                        ...
                        if (resources_1.isEqualOrParent(resource, e.target, false /* do not ignorecase, see https://github.com/Microsoft/vscode/issues/56384 */)) {
                    ...
                    for (const sourceModel of sourceModels) {
                        ...
                        if (resources_1.isEqual(sourceModelResource, e.source)) {
