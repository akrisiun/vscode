            ...
            doTouch(versionId, reason) {
                ...
                return this.saveSequentializer.setPending(versionId, (async () => {
                    try {
                        ...
                        errors_1.onUnexpectedError(error); // just log any error but do not notify the user since the file was not dirty
                    }
                })());
            }
