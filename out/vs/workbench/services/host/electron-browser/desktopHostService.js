...
define(["require", "exports", "vs/base/common/event", "vs/workbench/services/host/browser/host", "vs/platform/electron/node/electron", "vs/platform/instantiation/common/extensions", "vs/platform/label/common/label", "vs/workbench/services/environment/common/environmentService", "vs/platform/windows/common/windows", "vs/base/common/lifecycle"], function (require, exports, event_1, host_1, electron_1, extensions_1, label_1, environmentService_1, windows_1, lifecycle_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.DesktopHostService = void 0;
    let DesktopHostService = /** @class */ (() => {
        let DesktopHostService = class DesktopHostService extends lifecycle_1.Disposable {
            constructor(electronService, labelService, environmentService) {
                super();
                this.electronService = electronService;
                this.labelService = labelService;
                this.environmentService = environmentService;
                this._onDidChangeFocus = event_1.Event.any(event_1.Event.map(event_1.Event.filter(this.electronService.onWindowFocus, id => id === this.environmentService.configuration.windowId), () => this.hasFocus), event_1.Event.map(event_1.Event.filter(this.electronService.onWindowBlur, id => id === this.environmentService.configuration.windowId), () => this.hasFocus));
            }
