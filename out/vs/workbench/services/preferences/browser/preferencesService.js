    ...
    let PreferencesService = /** @class */ (() => {
        let PreferencesService = class PreferencesService extends lifecycle_1.Disposable {
            ...
            async getPositionToEdit(settingKey, settingsModel, codeEditor) {
                ...
                if (!setting) {
                    const defaultValue = type === 'array' ? this.configurationService.inspect(settingKey).defaultValue : configurationRegistry_1.getDefaultValue(type);
