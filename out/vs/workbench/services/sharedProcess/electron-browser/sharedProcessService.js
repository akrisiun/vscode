...
define(["require", "exports", "vs/base/parts/ipc/node/ipc.net", "vs/base/parts/ipc/common/ipc", "vs/platform/ipc/electron-browser/mainProcessService", "vs/platform/ipc/electron-browser/sharedProcessService", "vs/platform/instantiation/common/extensions", "vs/workbench/services/environment/common/environmentService"], function (require, exports, ipc_net_1, ipc_1, mainProcessService_1, sharedProcessService_1, extensions_1, environmentService_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.SharedProcessService = void 0;
    let SharedProcessService = /** @class */ (() => {
        let SharedProcessService = class SharedProcessService {
            constructor(mainProcessService, environmentService) {
                ...
                this.withSharedProcessConnection = this.whenSharedProcessReady()
                    .then(() => ipc_net_1.connect(environmentService.sharedIPCHandle, `window:${environmentService.configuration.windowId}`));
            }
