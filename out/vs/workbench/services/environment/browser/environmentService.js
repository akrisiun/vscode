...
define(["require", "exports", "vs/base/common/network", "vs/base/common/resources", "vs/base/common/uri", "vs/base/common/uuid", "vs/platform/environment/common/environment", "vs/platform/product/common/product", "vs/base/common/decorators", "vs/base/common/errors"], function (require, exports, network_1, resources_1, uri_1, uuid_1, environment_1, product_1, decorators_1, errors_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.BrowserWorkbenchEnvironmentService = exports.BrowserEnvironmentConfiguration = void 0;
    let BrowserEnvironmentConfiguration = /** @class */ (() => {
            ...
            get filesToDiff() {
                if (this.payload) {
                    ...
                    if (fileToDiffDetail && fileToDiffMaster) {
                        return [
                            { fileUri: uri_1.URI.parse(fileToDiffDetail) },
                            { fileUri: uri_1.URI.parse(fileToDiffMaster) }
                        ];
                    }
                }
                return undefined;
        ...
        return BrowserEnvironmentConfiguration;
    })();
    exports.BrowserEnvironmentConfiguration = BrowserEnvironmentConfiguration;
    let BrowserWorkbenchEnvironmentService = /** @class */ (() => {
        ...
        return BrowserWorkbenchEnvironmentService;
    })();
