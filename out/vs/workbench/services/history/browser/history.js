    ...
    let HistoryService = /** @class */ (() => {
        let HistoryService = class HistoryService extends lifecycle_1.Disposable {
            ...
            matchesFile(resource, arg2) {
                ...
                return (resourceEditorInput === null || resourceEditorInput === void 0 ? void 0 : resourceEditorInput.resource.toString()) === resource.toString();
            }
            ...
            containsRecentlyClosedFile(group, recentlyClosedEditor) {
                for (const editor of group.editors) {
                    if (resources_1.isEqual(editor.resource, recentlyClosedEditor.resource)) {
                        return true;
                    }
                }
                return false;
