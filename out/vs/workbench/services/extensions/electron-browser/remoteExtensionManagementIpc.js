 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "os", "vs/base/common/uri", "vs/platform/extensionManagement/common/extensionManagementUtil", "vs/base/common/errorMessage", "vs/workbench/services/extensions/common/extensionsUtil", "vs/base/common/arrays", "vs/base/common/map", "vs/base/common/cancellation", "vs/nls", "vs/platform/extensionManagement/common/extensionManagementIpc", "vs/base/common/uuid", "vs/base/common/resources"], function (require, exports, os_1, uri_1, extensionManagementUtil_1, errorMessage_1, extensionsUtil_1, arrays_1, map_1, cancellation_1, nls_1, extensionManagementIpc_1, uuid_1, resources_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.RemoteExtensionManagementChannelClient = void 0;
    class RemoteExtensionManagementChannelClient extends extensionManagementIpc_1.ExtensionManagementChannelClient {
        ...
        async downloadAndInstall(extension, installed) {
            const location = resources_1.joinPath(uri_1.URI.file(os_1.tmpdir()), uuid_1.generateUuid());
            await this.galleryService.download(extension, location, installed.filter(i => extensionManagementUtil_1.areSameExtensions(i.identifier, extension.identifier))[0] ? 2 /* Update */ : 1 /* Install */);
