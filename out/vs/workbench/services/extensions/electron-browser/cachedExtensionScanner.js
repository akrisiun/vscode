...
define(["require", "exports", "vs/nls", "os", "vs/base/common/path", "vs/base/common/amd", "vs/base/common/errors", "vs/base/common/network", "vs/base/common/objects", "vs/base/common/platform", "vs/base/common/resources", "vs/base/common/uri", "vs/base/node/pfs", "vs/workbench/services/environment/common/environmentService", "vs/workbench/services/extensionManagement/common/extensionManagement", "vs/platform/extensions/common/extensions", "vs/platform/product/common/product", "vs/platform/notification/common/notification", "vs/workbench/services/host/browser/host", "vs/workbench/services/extensions/node/extensionPoints"], function (require, exports, nls, os, path, amd_1, errors, network_1, objects, platform, resources_1, uri_1, pfs, environmentService_1, extensionManagement_1, extensions_1, product_1, notification_1, host_1, extensionPoints_1) {
    "use strict";
    ...
    let CachedExtensionScanner = /** @class */ (() => {
        let CachedExtensionScanner = class CachedExtensionScanner {
            ...
            static _scanInstalledExtensions(hostService, notificationService, environmentService, extensionEnablementService, log, translations) {
                ...
                if (devMode) {
                    const builtInExtensions = Promise.resolve(product_1.default.builtInExtensions || []);
