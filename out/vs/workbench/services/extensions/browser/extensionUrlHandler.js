    ...
    let ExtensionUrlHandler = class ExtensionUrlHandler {
        ...
        async handleURL(uri, options) {
            ...
            if (options && options.trusted) {
                ...
                showConfirm = !confirmedExtensionIds.has(extensions_2.ExtensionIdentifier.toKey(extensionId));
            }
            if (showConfirm) {
