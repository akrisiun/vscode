...
define(["require", "exports", "vs/nls", "os", "vs/platform/product/common/product", "vs/base/common/severity", "vs/base/common/platform", "vs/base/common/labels", "vs/platform/dialogs/common/dialogs", "vs/workbench/services/dialogs/browser/dialogService", "vs/platform/log/common/log", "vs/platform/instantiation/common/extensions", "vs/platform/ipc/electron-browser/sharedProcessService", "vs/platform/dialogs/electron-browser/dialogIpc", "vs/platform/configuration/common/configuration", "vs/platform/layout/browser/layoutService", "vs/platform/theme/common/themeService", "vs/platform/keybinding/common/keybinding", "vs/platform/product/common/productService", "vs/platform/clipboard/common/clipboardService", "vs/platform/electron/node/electron", "vs/base/common/date"], function (require, exports, nls, os, product_1, severity_1, platform_1, labels_1, dialogs_1, dialogService_1, log_1, extensions_1, sharedProcessService_1, dialogIpc_1, configuration_1, layoutService_1, themeService_1, keybinding_1, productService_1, clipboardService_1, electron_1, date_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.DialogService = void 0;
    let DialogService = /** @class */ (() => {
        ...
        let NativeDialogService = class NativeDialogService {
            ...
            async about() {
                ...
                const detailString = (useAgo) => {
                    return nls.localize('aboutDetail', "Version: {0}\nCommit: {1}\nDate: {2}\nElectron: {3}\nChrome: {4}\nNode.js: {5}\nV8: {6}\nOS: {7}", version, product_1.default.commit || 'Unknown', product_1.default.date ? `${product_1.default.date}${useAgo ? ' (' + date_1.fromNow(new Date(product_1.default.date), true) + ')' : ''}` : 'Unknown', process.versions['electron'], process.versions['chrome'], process.versions['node'], process.versions['v8'], `${os.type()} ${os.arch()} ${os.release()}${isSnap ? ' snap' : ''}`);
                };
