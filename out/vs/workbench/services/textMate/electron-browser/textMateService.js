...
define(["require", "exports", "vs/workbench/services/textMate/common/textMateService", "vs/platform/instantiation/common/extensions", "vs/workbench/services/textMate/browser/abstractTextMateService", "vs/editor/common/services/modeService", "vs/workbench/services/themes/common/workbenchThemeService", "vs/platform/notification/common/notification", "vs/platform/log/common/log", "vs/platform/configuration/common/configuration", "vs/editor/common/services/webWorker", "vs/editor/common/services/modelService", "vs/base/common/lifecycle", "vs/base/common/uri", "vs/editor/common/model/tokensStore", "vs/platform/storage/common/storage", "vs/workbench/services/extensionResourceLoader/common/extensionResourceLoader", "vs/workbench/services/environment/common/environmentService", "vs/platform/progress/common/progress"], function (require, exports, textMateService_1, extensions_1, abstractTextMateService_1, modeService_1, workbenchThemeService_1, notification_1, log_1, configuration_1, webWorker_1, modelService_1, lifecycle_1, uri_1, tokensStore_1, storage_1, extensionResourceLoader_1, environmentService_1, progress_1) {
    ...
    let TextMateWorkerHost = /** @class */ (() => {
        ...
        return TextMateWorkerHost;
    })();
    exports.TextMateWorkerHost = TextMateWorkerHost;
    let TextMateService = /** @class */ (() => {
        let TextMateService = class TextMateService extends abstractTextMateService_1.AbstractTextMateService {
            ...
            async _loadVSCodeOnigurumWASM() {
                const wasmPath = (this._environmentService.isBuilt
