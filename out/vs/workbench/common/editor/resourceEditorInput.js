...
define(["require", "exports", "vs/workbench/common/editor", "vs/editor/common/services/resolverService", "vs/workbench/common/editor/resourceEditorModel", "vs/workbench/services/textfile/common/textfiles", "vs/workbench/services/editor/common/editorService", "vs/workbench/services/editor/common/editorGroupsService", "vs/platform/files/common/files", "vs/platform/label/common/label", "vs/workbench/services/filesConfiguration/common/filesConfigurationService"], function (require, exports, editor_1, resolverService_1, resourceEditorModel_1, textfiles_1, editorService_1, editorGroupsService_1, files_1, label_1, filesConfigurationService_1) {
    "use strict";
     ...
     * code editor model.
     */
    let ResourceEditorInput = /** @class */ (() => {
        let ResourceEditorInput = class ResourceEditorInput extends editor_1.TextResourceEditorInput {
            constructor(name, description, resource, preferredMode, textModelResolverService, textFileService, editorService, editorGroupService, fileService, labelService, filesConfigurationService) {
