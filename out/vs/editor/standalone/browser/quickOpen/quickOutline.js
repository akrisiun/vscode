 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "vs/base/common/cancellation", "vs/base/common/filters", "vs/base/common/strings", "vs/base/parts/quickopen/browser/quickOpenModel", "vs/base/parts/quickopen/common/quickOpen", "vs/editor/browser/editorExtensions", "vs/editor/common/core/range", "vs/editor/common/editorContextKeys", "vs/editor/common/modes", "vs/editor/contrib/quickOpen/quickOpen", "vs/editor/standalone/browser/quickOpen/editorQuickOpen", "vs/platform/keybinding/common/keybindingsRegistry", "vs/editor/common/standaloneStrings", "vs/css!./quickOutline"], function (require, exports, cancellation_1, filters_1, strings, quickOpenModel_1, quickOpen_1, editorExtensions_1, range_1, editorContextKeys_1, modes_1, quickOpen_2, editorQuickOpen_1, keybindingsRegistry_1, standaloneStrings_1) {
    "use strict";
    ...
    class QuickOutlineAction extends editorQuickOpen_1.BaseEditorQuickOpenAction {
        ...
        run(accessor, editor) {
            ...
            // Resolve outline
            return quickOpen_2.getDocumentSymbols(model, true, cancellation_1.CancellationToken.None).then((result) => {
                if (result.length === 0) {
                    return;
                }
