...
define(["require", "exports", "vs/base/browser/browser", "vs/base/browser/dom", "vs/base/browser/fastDomNode", "vs/base/browser/formattedTextRenderer", "vs/base/browser/ui/aria/aria", "vs/base/browser/ui/widget", "vs/base/common/lifecycle", "vs/base/common/platform", "vs/base/common/strings", "vs/base/common/uri", "vs/editor/browser/editorExtensions", "vs/editor/common/editorContextKeys", "vs/editor/contrib/toggleTabFocusMode/toggleTabFocusMode", "vs/platform/contextkey/common/contextkey", "vs/platform/instantiation/common/instantiation", "vs/platform/keybinding/common/keybinding", "vs/platform/keybinding/common/keybindingsRegistry", "vs/platform/opener/common/opener", "vs/platform/theme/common/colorRegistry", "vs/platform/theme/common/themeService", "vs/editor/common/standaloneStrings", "vs/css!./accessibilityHelp"], function (require, exports, browser, dom, fastDomNode_1, formattedTextRenderer_1, aria_1, widget_1, lifecycle_1, platform, strings, uri_1, editorExtensions_1, editorContextKeys_1, toggleTabFocusMode_1, contextkey_1, instantiation_1, keybinding_1, keybindingsRegistry_1, opener_1, colorRegistry_1, themeService_1, standaloneStrings_1) {
    "use strict";
    ...
    let AccessibilityHelpWidget = class AccessibilityHelpWidget extends widget_1.Widget {
        ...
        _buildContent() {
            ...
            if (options.get(41 /* inDiffEditor */)) {
                if (options.get(63 /* readOnly */)) {
            ...
            if (options.get(100 /* tabFocusMode */)) {
