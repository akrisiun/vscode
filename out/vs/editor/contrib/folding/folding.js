...
define(["require", "exports", "vs/nls", "vs/base/common/types", "vs/base/common/strings", "vs/base/common/async", "vs/base/common/keyCodes", "vs/base/common/lifecycle", "vs/editor/browser/editorExtensions", "vs/editor/contrib/folding/foldingModel", "./foldingDecorations", "vs/editor/common/editorContextKeys", "vs/editor/contrib/folding/hiddenRangeModel", "vs/editor/common/modes/languageConfigurationRegistry", "vs/editor/contrib/folding/indentRangeProvider", "vs/editor/common/modes", "./syntaxRangeProvider", "vs/editor/contrib/folding/intializingRangeProvider", "vs/platform/keybinding/common/keybindingsRegistry", "vs/base/common/errors", "vs/platform/contextkey/common/contextkey", "vs/css!./folding"], function (require, exports, nls, types, strings_1, async_1, keyCodes_1, lifecycle_1, editorExtensions_1, foldingModel_1, foldingDecorations_1, editorContextKeys_1, hiddenRangeModel_1, languageConfigurationRegistry_1, indentRangeProvider_1, modes_1, syntaxRangeProvider_1, intializingRangeProvider_1, keybindingsRegistry_1, errors_1, contextkey_1) {
    ...
    let FoldingController = class FoldingController extends lifecycle_1.Disposable {
        constructor(editor, contextKeyService) {
            ...
            this._isEnabled = options.get(27 /* folding */);
            this._autoHideFoldingControls = options.get(78 /* showFoldingControls */) === 'mouseover';
            this._useFoldingProviders = options.get(28 /* foldingStrategy */) !== 'indentation';
            ...
            this._register(this.editor.onDidChangeConfiguration((e) => {
                if (e.hasChanged(27 /* folding */) || e.hasChanged(78 /* showFoldingControls */) || e.hasChanged(28 /* foldingStrategy */)) {
