define(["require", "exports", "assert", "vs/editor/contrib/folding/foldingModel", "vs/editor/common/model/textModel", "vs/editor/test/common/editorTestUtils", "vs/editor/contrib/folding/indentRangeProvider", "vs/editor/common/core/editOperation", "vs/editor/common/core/position", "vs/editor/common/core/range", "vs/base/common/strings"], function (require, exports, assert, foldingModel_1, textModel_1, editorTestUtils_1, indentRangeProvider_1, editOperation_1, position_1, range_1, strings_1) {
    ...
    let TestDecorationProvider = /** @class */ (() => {
    ...
    suite('Folding Model', () => {
        ...
        test('getRegionAtLine', () => {
            ...
            let textModel = editorTestUtils_1.createTextModel(lines.join('\n'));
            try {
        ...
        test('setCollapseStateUp', () => {
            ...
            try {
                ...
                let r5 = r(9, 10, false);
                assertRanges(foldingModel, [r1, r2, r3, r4, r5]);
                foldingModel_1.setCollapseStateUp(foldingModel, true, [5]);
                assertFoldedRanges(foldingModel, [r4], '1');
                foldingModel_1.setCollapseStateUp(foldingModel, true, [5]);
                assertFoldedRanges(foldingModel, [r3, r4], '2');
                foldingModel_1.setCollapseStateUp(foldingModel, true, [4]);
