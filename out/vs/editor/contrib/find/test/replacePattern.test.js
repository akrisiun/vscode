...
define(["require", "exports", "assert", "vs/editor/contrib/find/replacePattern", "vs/base/common/search"], function (require, exports, assert, replacePattern_1, search_1) {
    ...
    suite('Replace Pattern test', () => {
        ...
        test('buildReplaceStringWithCasePreserved test', () => {
            ...
            assert.equal(search_1.buildReplaceStringWithCasePreserved(actual, 'newfoo-newbar'), 'newfoo-NEWBAR');
            actual = ['Foo_Bar'];
            assert.equal(search_1.buildReplaceStringWithCasePreserved(actual, 'newfoo_newbar'), 'Newfoo_Newbar');
            actual = ['Foo_Bar_Abc'];
            assert.equal(search_1.buildReplaceStringWithCasePreserved(actual, 'newfoo_newbar_newabc'), 'Newfoo_Newbar_Newabc');
            actual = ['Foo_Bar_abc'];
            assert.equal(search_1.buildReplaceStringWithCasePreserved(actual, 'newfoo_newbar'), 'Newfoo_newbar');
            actual = ['Foo_Bar-abc'];
            assert.equal(search_1.buildReplaceStringWithCasePreserved(actual, 'newfoo_newbar-abc'), 'Newfoo_newbar-abc');
            actual = ['foo_Bar'];
            assert.equal(search_1.buildReplaceStringWithCasePreserved(actual, 'newfoo_newbar'), 'newfoo_Newbar');
            actual = ['Foo_BAR'];
            assert.equal(search_1.buildReplaceStringWithCasePreserved(actual, 'newfoo_newbar'), 'Newfoo_NEWBAR');
        ...
        test('preserve case', () => {
            ...
            actual = replacePattern.buildReplaceString(['foo-BAR'], true);
            assert.equal(actual, 'newfoo-NEWBAR');
            replacePattern = replacePattern_1.parseReplaceString('newfoo_newbar');
            actual = replacePattern.buildReplaceString(['Foo_Bar'], true);
            assert.equal(actual, 'Newfoo_Newbar');
            replacePattern = replacePattern_1.parseReplaceString('newfoo_newbar_newabc');
            actual = replacePattern.buildReplaceString(['Foo_Bar_Abc'], true);
            assert.equal(actual, 'Newfoo_Newbar_Newabc');
            replacePattern = replacePattern_1.parseReplaceString('newfoo_newbar');
            actual = replacePattern.buildReplaceString(['Foo_Bar_abc'], true);
            assert.equal(actual, 'Newfoo_newbar');
            replacePattern = replacePattern_1.parseReplaceString('newfoo_newbar-abc');
