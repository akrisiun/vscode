    ...
    class FindWidget extends widget_1.Widget {
        constructor(codeEditor, controller, state, contextViewProvider, keybindingService, contextKeyService, themeService, storageService, notificationService) {
            ...
            this._register(this._codeEditor.onDidChangeConfiguration((e) => {
                if (e.hasChanged(63 /* readOnly */)) {
                    if (this._codeEditor.getOption(63 /* readOnly */)) {
                ...
                if (e.hasChanged(25 /* find */)) {
                    const addExtraSpaceOnTop = this._codeEditor.getOption(25 /* find */).addExtraSpaceOnTop;
            ...
            if (this._codeEditor.getOption(25 /* find */).addExtraSpaceOnTop) {
        ...
        _onStateChanged(e) {
            ...
            if (e.isReplaceRevealed) {
                if (this._state.isReplaceRevealed) {
                    if (!this._codeEditor.getOption(63 /* readOnly */) && !this._isReplaceVisible) {
        ...
        _updateButtons() {
            ...
            let canReplace = !this._codeEditor.getOption(63 /* readOnly */);
        ...
        _reveal() {
            if (!this._isVisible) {
                ...
                if (isSelection && this._codeEditor.getOption(25 /* find */).autoFindInSelection) {
                    this._toggleSelectionFind.checked = true;
                }
                else {
                    this._toggleSelectionFind.checked = false;
                ...
                if (this._codeEditor.getOption(25 /* find */).seedSearchStringFromSelection && selection) {
