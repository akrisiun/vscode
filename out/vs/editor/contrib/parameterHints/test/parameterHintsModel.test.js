 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/base/common/lifecycle", "vs/base/common/uri", "vs/editor/common/editorCommon", "vs/editor/test/common/editorTestUtils", "vs/editor/common/modes", "vs/editor/test/browser/testCodeEditor", "vs/platform/instantiation/common/serviceCollection", "vs/platform/storage/common/storage", "vs/platform/telemetry/common/telemetry", "vs/platform/telemetry/common/telemetryUtils", "vs/editor/contrib/parameterHints/parameterHintsModel"], function (require, exports, assert, lifecycle_1, uri_1, editorCommon_1, editorTestUtils_1, modes, testCodeEditor_1, serviceCollection_1, storage_1, telemetry_1, telemetryUtils_1, parameterHintsModel_1) {
    "use strict";
    ...
    suite('ParameterHintsModel', () => {
        ...
        function createMockEditor(fileContents) {
            const textModel = editorTestUtils_1.createTextModel(fileContents, undefined, undefined, mockFile);
