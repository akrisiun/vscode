define(["require", "exports", "assert", "vs/editor/common/core/position", "vs/editor/common/core/selection", "vs/editor/test/common/editorTestUtils", "vs/editor/common/modes", "vs/editor/common/modes/languageConfigurationRegistry", "vs/editor/contrib/bracketMatching/bracketMatching", "vs/editor/test/browser/testCodeEditor", "vs/editor/test/common/mocks/mockMode"], function (require, exports, assert, position_1, selection_1, editorTestUtils_1, modes_1, languageConfigurationRegistry_1, bracketMatching_1, testCodeEditor_1, mockMode_1) {
    ...
    suite('bracket matching', () => {
        ...
        test('issue #183: jump to matching bracket position', () => {
            ...
            let model = editorTestUtils_1.createTextModel('var x = (3 + (5-7)) + ((5+3)+5);', undefined, mode.getLanguageIdentifier());
        ...
        test('Jump to next bracket', () => {
            let mode = new BracketMode();
            let model = editorTestUtils_1.createTextModel('var x = (3 + (5-7)); y();', undefined, mode.getLanguageIdentifier());
            testCodeEditor_1.withTestCodeEditor(null, { model: model }, (editor, cursor) => {
                let bracketMatchingController = editor.registerAndInstantiateContribution(bracketMatching_1.BracketMatchingController.ID, bracketMatching_1.BracketMatchingController);
        ...
        test('issue #1772: jump to enclosing brackets', () => {
            ...
            const model = editorTestUtils_1.createTextModel(text, undefined, mode.getLanguageIdentifier());
            testCodeEditor_1.withTestCodeEditor(null, { model: model }, (editor, cursor) => {
        ...
        test('issue #45369: Select to Bracket with multicursor', () => {
            let mode = new BracketMode();
            let model = editorTestUtils_1.createTextModel('{  }   {   }   { }', undefined, mode.getLanguageIdentifier());
            testCodeEditor_1.withTestCodeEditor(null, { model: model }, (editor, cursor) => {
                let bracketMatchingController = editor.registerAndInstantiateContribution(bracketMatching_1.BracketMatchingController.ID, bracketMatching_1.BracketMatchingController);
