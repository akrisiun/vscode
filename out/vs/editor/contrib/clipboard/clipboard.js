...
define(["require", "exports", "vs/nls", "vs/base/browser/browser", "vs/base/common/platform", "vs/editor/browser/controller/textAreaInput", "vs/editor/browser/editorExtensions", "vs/editor/browser/services/codeEditorService", "vs/editor/common/editorContextKeys", "vs/platform/keybinding/common/keybindingsRegistry", "vs/css!./clipboard"], function (require, exports, nls, browser, platform, textAreaInput_1, editorExtensions_1, codeEditorService_1, editorContextKeys_1, keybindingsRegistry_1) {
    ...
    class ExecCommandCutAction extends ExecCommandAction {
        ...
        run(accessor, editor) {
            ...
            const emptySelectionClipboard = editor.getOption(22 /* emptySelectionClipboard */);
