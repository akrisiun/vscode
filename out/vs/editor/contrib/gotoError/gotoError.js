...
define(["require", "exports", "vs/nls", "vs/base/common/event", "vs/base/common/lifecycle", "vs/platform/contextkey/common/contextkey", "vs/platform/markers/common/markers", "vs/editor/common/core/range", "vs/editor/browser/editorExtensions", "vs/platform/theme/common/themeService", "vs/editor/common/editorContextKeys", "./gotoErrorWidget", "vs/base/common/strings", "vs/base/common/arrays", "vs/editor/browser/services/codeEditorService", "vs/base/common/errors", "vs/platform/actions/common/actions", "vs/base/common/actions", "vs/platform/keybinding/common/keybinding", "vs/base/common/resources", "vs/platform/opener/common/opener", "vs/base/common/codicons"], function (require, exports, nls, event_1, lifecycle_1, contextkey_1, markers_1, range_1, editorExtensions_1, themeService_1, editorContextKeys_1, gotoErrorWidget_1, strings_1, arrays_1, codeEditorService_1, errors_1, actions_1, actions_2, keybinding_1, resources_1, opener_1, codicons_1) {
    ...
    const markerNavigationNextIcon = codicons_1.registerIcon('marker-navigation-next', codicons_1.Codicon.chevronDown);
    const markerNavigationPreviousIcon = codicons_1.registerIcon('marker-navigation-previous', codicons_1.Codicon.chevronUp);
    let MarkerController = /** @class */ (() => {
        let MarkerController = class MarkerController {
            constructor(editor, _markerService, _contextKeyService, _themeService, _editorService, _keybindingService, _openerService) {
            ...
            getOrCreateModel() {
                ...
                const actions = [
                    new actions_2.Action(NextMarkerAction.ID, NextMarkerAction.LABEL + (nextMarkerKeybinding ? ` (${nextMarkerKeybinding.getLabel()})` : ''), 'show-next-problem ' + markerNavigationNextIcon.classNames, this._model.canNavigate(), async () => { if (this._model) {
                        this._model.move(true, true);
                    } }),
                    new actions_2.Action(PrevMarkerAction.ID, PrevMarkerAction.LABEL + (prevMarkerKeybinding ? ` (${prevMarkerKeybinding.getLabel()})` : ''), 'show-previous-problem ' + markerNavigationPreviousIcon.classNames, this._model.canNavigate(), async () => { if (this._model) {
                        this._model.move(false, true);
                    } })
                ];
                this._widget = new gotoErrorWidget_1.MarkerNavigationWidget(this._editor, actions, this._themeService, this._openerService);
    ...
    class MarkerNavigationAction extends editorExtensions_1.EditorAction {
        ...
        run(accessor, editor) {
            ...
            return editorService.openCodeEditor({
                ...
                options: { pinned: false, revealIfOpened: true, selectionRevealType: 2 /* NearTop */, selection: newMarker }
            }, editor).then(editor => {
                if (!editor) {
                    return undefined;
                }
        ...
        class NextMarkerAction extends MarkerNavigationAction {
            constructor() {
                super(true, false, {
                    ...
                    kbOpts: { kbExpr: editorContextKeys_1.EditorContextKeys.focus, primary: 512 /* Alt */ | 66 /* F8 */, weight: 100 /* EditorContrib */ }
                });
            }
        }
        ...
        class PrevMarkerAction extends MarkerNavigationAction {
            constructor() {
                super(false, false, {
                    ...
                    precondition: undefined,
                    kbOpts: { kbExpr: editorContextKeys_1.EditorContextKeys.focus, primary: 1024 /* Shift */ | 512 /* Alt */ | 66 /* F8 */, weight: 100 /* EditorContrib */ }
                });
            }
        }
