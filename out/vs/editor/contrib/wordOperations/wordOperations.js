 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "vs/editor/browser/editorExtensions", "vs/editor/common/commands/replaceCommand", "vs/editor/common/controller/cursorCommon", "vs/editor/common/controller/cursorWordOperations", "vs/editor/common/controller/wordCharacterClassifier", "vs/editor/common/core/position", "vs/editor/common/core/range", "vs/editor/common/core/selection", "vs/editor/common/editorContextKeys", "vs/platform/keybinding/common/keybindingsRegistry", "vs/platform/accessibility/common/accessibility", "vs/platform/contextkey/common/contextkey", "vs/editor/common/config/editorOptions"], function (require, exports, editorExtensions_1, replaceCommand_1, cursorCommon_1, cursorWordOperations_1, wordCharacterClassifier_1, position_1, range_1, selection_1, editorContextKeys_1, keybindingsRegistry_1, accessibility_1, contextkey_1, editorOptions_1) {
    "use strict";
    ...
    class MoveWordCommand extends editorExtensions_1.EditorCommand {
        ...
        runEditorCommand(accessor, editor, args) {
            ...
            const wordSeparators = wordCharacterClassifier_1.getMapForWordSeparators(editor.getOption(90 /* wordSeparators */));
        ...
        constructor() {
            super({
                ...
                kbOpts: {
                    ...
                    primary: 2048 /* CtrlCmd */ | 15 /* LeftArrow */,
                    mac: { primary: 512 /* Alt */ | 15 /* LeftArrow */ },
                    weight: keybindingsRegistry_1.KeybindingWeight.EditorContrib + 1
                }
            });
        }
