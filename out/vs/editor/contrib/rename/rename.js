    ...
    let RenameController = /** @class */ (() => {
        let RenameController = class RenameController {
            ...
            async run() {
                ...
                this.editor.focus();
                const renameOperation = async_1.raceCancellation(skeleton.provideRenameEdits(inputFieldResult.newName, 0, [], this._cts.token), this._cts.token).then(async (renameResult) => {
