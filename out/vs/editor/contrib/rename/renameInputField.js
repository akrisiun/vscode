...
define(["require", "exports", "vs/base/common/lifecycle", "vs/editor/common/core/position", "vs/nls", "vs/platform/contextkey/common/contextkey", "vs/platform/theme/common/colorRegistry", "vs/platform/theme/common/themeService", "vs/platform/keybinding/common/keybinding", "vs/base/browser/dom", "vs/css!./renameInputField"], function (require, exports, lifecycle_1, position_1, nls_1, contextkey_1, colorRegistry_1, themeService_1, keybinding_1, dom_1) {
    "use strict";
    ...
    let RenameInputField = /** @class */ (() => {
        let RenameInputField = class RenameInputField {
            ...
            getDomNode() {
                if (!this._domNode) {
                    ...
                    const updateLabel = () => {
                        ...
                        this._label.innerText = nls_1.localize('label', "{0} to Rename, {1} to Preview", (_a = this._keybindingService.lookupKeybinding(accept)) === null || _a === void 0 ? void 0 : _a.getLabel(), (_b = this._keybindingService.lookupKeybinding(preview)) === null || _b === void 0 ? void 0 : _b.getLabel());
                    };
                    updateLabel();
            ...
            getInput(where, value, selectionStart, selectionEnd, supportPreview, token) {
                dom_1.toggleClass(this._domNode, 'preview', supportPreview);
