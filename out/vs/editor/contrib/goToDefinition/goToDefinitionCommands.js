...
define(["require", "exports", "vs/base/browser/ui/aria/aria", "vs/base/common/async", "vs/base/common/keyCodes", "vs/base/common/platform", "vs/editor/browser/editorExtensions", "vs/editor/browser/services/codeEditorService", "vs/editor/common/core/range", "vs/editor/common/editorContextKeys", "vs/editor/common/modes", "vs/editor/contrib/message/messageController", "vs/editor/contrib/referenceSearch/peekViewWidget", "vs/editor/contrib/referenceSearch/referencesController", "vs/editor/contrib/referenceSearch/referencesModel", "vs/nls", "vs/platform/actions/common/actions", "vs/platform/contextkey/common/contextkey", "vs/platform/keybinding/common/keybindingsRegistry", "vs/platform/notification/common/notification", "vs/platform/progress/common/progress", "./goToDefinition", "vs/platform/commands/common/commands", "vs/editor/browser/core/editorState", "vs/editor/contrib/goToDefinition/goToDefinitionResultsNavigation", "vs/base/common/resources"], function (require, exports, aria_1, async_1, keyCodes_1, platform, editorExtensions_1, codeEditorService_1, range_1, editorContextKeys_1, modes_1, messageController_1, peekViewWidget_1, referencesController_1, referencesModel_1, nls, actions_1, contextkey_1, keybindingsRegistry_1, notification_1, progress_1, goToDefinition_1, commands_1, editorState_1, goToDefinitionResultsNavigation_1, resources_1) {
    ...
    class DefinitionAction extends editorExtensions_1.EditorAction {
        ...
        run(accessor, editor) {
            ...
            const definitionPromise = async_1.raceCancellation(this._getTargetLocationForPosition(model, pos, cts.token), cts.token).then(async (references) => {
        ...
        async _onResult(editorService, symbolNavService, editor, model) {
            ...
            aria_1.alert(msg);
            const gotoLocation = editor.getOption(37 /* gotoLocation */);
