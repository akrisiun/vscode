        ...
        let ItemRenderer = class ItemRenderer {
            ...
            renderElement(element, index, templateData) {
                ...
                if (typeof suggestion.label === 'string') {
                    ...
                    dom_1.addClass(data.root, 'string-label');
                }
                else {
                    ...
                    dom_1.removeClass(data.root, 'string-label');
                }
                if (canExpandCompletionItem(element)) {
                    dom_1.addClass(data.right, 'can-expand-details');
                    ...
                    dom_1.removeClass(data.right, 'can-expand-details');
    ...
    let SuggestWidget = /** @class */ (() => {
        let SuggestWidget = class SuggestWidget {
            constructor(editor, telemetryService, keybindingService, contextKeyService, themeService, storageService, modeService, openerService, menuService, instantiationService) {
                ...
                const applyStatusBarStyle = () => dom_1.toggleClass(this.element, 'with-status-bar', this.editor.getOption(96 /* suggest */).statusBar.visible);
                applyStatusBarStyle();
                ...
                const applyIconStyle = () => dom_1.toggleClass(this.element, 'no-icons', !this.editor.getOption(96 /* suggest */).showIcons);
                applyIconStyle();
