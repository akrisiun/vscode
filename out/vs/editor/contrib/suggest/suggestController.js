...
define(["require", "exports", "vs/base/browser/ui/aria/aria", "vs/base/common/arrays", "vs/base/common/errors", "vs/base/common/keyCodes", "vs/base/common/lifecycle", "vs/editor/browser/editorExtensions", "vs/editor/common/core/editOperation", "vs/editor/common/core/range", "vs/editor/common/editorContextKeys", "vs/editor/contrib/snippet/snippetController2", "vs/editor/contrib/snippet/snippetParser", "vs/editor/contrib/suggest/suggestMemory", "vs/nls", "vs/platform/commands/common/commands", "vs/platform/contextkey/common/contextkey", "vs/platform/instantiation/common/instantiation", "vs/platform/keybinding/common/keybindingsRegistry", "./suggest", "./suggestAlternatives", "./suggestModel", "./suggestWidget", "vs/editor/contrib/suggest/wordContextKey", "vs/base/common/event", "vs/editor/common/services/editorWorkerService", "vs/base/common/async", "vs/base/common/types", "./suggestCommitCharacters", "vs/editor/common/core/position", "vs/base/common/platform", "vs/platform/actions/common/actions"], function (require, exports, aria_1, arrays_1, errors_1, keyCodes_1, lifecycle_1, editorExtensions_1, editOperation_1, range_1, editorContextKeys_1, snippetController2_1, snippetParser_1, suggestMemory_1, nls, commands_1, contextkey_1, instantiation_1, keybindingsRegistry_1, suggest_1, suggestAlternatives_1, suggestModel_1, suggestWidget_1, wordContextKey_1, event_1, editorWorkerService_1, async_1, types_1, suggestCommitCharacters_1, position_1, platform, actions_1) {
    ...
    let SuggestController = /** @class */ (() => {
        let SuggestController = class SuggestController {
            constructor(editor, editorWorker, _memoryService, _commandService, _contextKeyService, _instantiationService) {
                ...
                this.editor = editor;
                this.model = new suggestModel_1.SuggestModel(this.editor, editorWorker);
            ...
            _insertSuggestion(event, flags) {
                ...
                if (Array.isArray(suggestion.additionalTextEdits)) {
                    this.editor.executeEdits('suggestController.additionalTextEdits', suggestion.additionalTextEdits.map(edit => editOperation_1.EditOperation.replace(range_1.Range.lift(edit.range), edit.text)));
                }
    ...
    let TriggerSuggestAction = /** @class */ (() => {
