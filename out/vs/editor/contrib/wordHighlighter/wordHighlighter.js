...
define(["require", "exports", "vs/nls", "vs/base/common/arrays", "vs/base/common/async", "vs/base/common/cancellation", "vs/base/common/errors", "vs/base/common/lifecycle", "vs/editor/browser/editorExtensions", "vs/editor/common/core/range", "vs/editor/common/editorContextKeys", "vs/editor/common/model", "vs/editor/common/model/textModel", "vs/editor/common/modes", "vs/platform/contextkey/common/contextkey", "vs/platform/keybinding/common/keybindingsRegistry", "vs/platform/theme/common/colorRegistry", "vs/platform/theme/common/themeService"], function (require, exports, nls, arrays, async_1, cancellation_1, errors_1, lifecycle_1, editorExtensions_1, range_1, editorContextKeys_1, model_1, textModel_1, modes_1, contextkey_1, keybindingsRegistry_1, colorRegistry_1, themeService_1) {
    ...
    class WordHighlighter {
        constructor(editor, contextKeyService) {
            ...
            this.occurrencesHighlight = this.editor.getOption(57 /* occurrencesHighlight */);
            ...
            this.toUnhook.add(editor.onDidChangeConfiguration((e) => {
                let newValue = this.editor.getOption(57 /* occurrencesHighlight */);
        ...
        _run() {
            ...
            if (workerRequestIsValid) {
                ...
                this.workerRequestCompleted = false;
                this.workerRequest = computeOccurencesAtPosition(this.model, this.editor.getSelection(), this.editor.getOption(90 /* wordSeparators */));
