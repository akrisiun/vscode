        ...
        class Cursor extends viewEvents.ViewEventEmitter {
            ...
            _onModelContentChanged(e) {
                ...
                if (hadFlushEvent) {
                    ...
                    if (this._hasFocus && e.resultingSelection && e.resultingSelection.length > 0) {
                        ...
                        if (this.setStates('modelChange', e.isUndoing ? 5 /* Undo */ : e.isRedoing ? 6 /* Redo */ : 2 /* RecoverFromMarkers */, cursorState)) {
                            this._revealRange('modelChange', 0 /* Primary */, 0 /* Simple */, true, 0 /* Smooth */);
                        }
                    }
                    else {
            ...
            getColumnSelectData() {
                ...
                return {
                    ...
                    fromViewVisualColumn: cursorCommon_1.CursorColumns.visibleColumnFromColumn2(this.context.config, this.context.viewModel, viewSelectionStart),
                    toViewLineNumber: viewPosition.lineNumber,
                    toViewVisualColumn: cursorCommon_1.CursorColumns.visibleColumnFromColumn2(this.context.config, this.context.viewModel, viewPosition),
                };
            }
            getSelections() {
            ...
            emitCursorRevealRange(source, viewRange, viewSelections, verticalType, revealHorizontal, scrollType) {
                try {
                    const eventsCollector = this._beginEmit();
            ...
            _type(source, text) {
                if (source === 'keyboard') {
                    ...
                    while (offset < len) {
                        ...
                        const autoClosedCharacters = AutoClosedAction.getAllAutoClosedCharacters(this._autoClosedActions);
                        this._executeEditOperation(cursorTypeOperations_1.TypeOperations.typeWithInterceptors(this._isDoingComposition, this._prevEditOperationType, this.context.config, this.context.model, this.getSelections(), autoClosedCharacters, chr));
                        offset += charLength;
                    }
                }
                else {
