...
define(["require", "exports", "vs/base/common/platform", "vs/editor/common/config/editorOptions", "vs/editor/common/config/editorZoom"], function (require, exports, platform, editorOptions_1, editorZoom_1) {
    ...
    class BareFontInfo {
        ...
        static createFromValidatedSettings(options, zoomLevel, ignoreEditorZoom) {
            const fontFamily = options.get(29 /* fontFamily */);
            const fontWeight = options.get(33 /* fontWeight */);
            const fontSize = options.get(32 /* fontSize */);
            const lineHeight = options.get(45 /* lineHeight */);
            const letterSpacing = options.get(42 /* letterSpacing */);
         ...
         * @internal
         */
        static _create(fontFamily, fontWeight, fontSize, lineHeight, letterSpacing, zoomLevel, ignoreEditorZoom) {
            if (lineHeight === 0) {
