...
define(["require", "exports", "vs/nls", "vs/base/common/platform", "vs/editor/common/model/wordHelper"], function (require, exports, nls, platform, wordHelper_1) {
    ...
    class EditorClassName extends ComputedEditorOption {
        constructor() {
            super(111 /* editorClassName */, [57 /* mouseStyle */, 27 /* extraEditorClassName */]);
        }
    ...
    class EditorLayoutInfoComputer extends ComputedEditorOption {
        constructor() {
            super(114 /* layoutInfo */, [42 /* glyphMargin */, 50 /* lineDecorationsWidth */, 31 /* folding */, 56 /* minimap */, 84 /* scrollbar */, 52 /* lineNumbers */]);
        }
        compute(env, options, _) {
    ...
    class EditorTabFocusMode extends ComputedEditorOption {
        constructor() {
            super(113 /* tabFocusMode */, [72 /* readOnly */]);
        }
        compute(env, options, _) {
    ...
    class EditorWrappingInfoComputer extends ComputedEditorOption {
        constructor() {
            super(115 /* wrappingInfo */, [104 /* wordWrap */, 107 /* wordWrapColumn */, 108 /* wordWrapMinified */, 114 /* layoutInfo */, 2 /* accessibilitySupport */]);
        }
        compute(env, options, _) {
            const wordWrap = options.get(104 /* wordWrap */);
            const wordWrapColumn = options.get(107 /* wordWrapColumn */);
            const wordWrapMinified = options.get(108 /* wordWrapMinified */);
            const layoutInfo = options.get(114 /* layoutInfo */);
    ...
    (function (EditorOption) {
        ...
        EditorOption[EditorOption["useTabStops"] = 102] = "useTabStops";
        EditorOption[EditorOption["wordSeparators"] = 103] = "wordSeparators";
        EditorOption[EditorOption["wordWrap"] = 104] = "wordWrap";
        EditorOption[EditorOption["wordWrapBreakAfterCharacters"] = 105] = "wordWrapBreakAfterCharacters";
        EditorOption[EditorOption["wordWrapBreakBeforeCharacters"] = 106] = "wordWrapBreakBeforeCharacters";
        EditorOption[EditorOption["wordWrapColumn"] = 107] = "wordWrapColumn";
        EditorOption[EditorOption["wordWrapMinified"] = 108] = "wordWrapMinified";
        EditorOption[EditorOption["wrappingIndent"] = 109] = "wrappingIndent";
        EditorOption[EditorOption["wrappingStrategy"] = 110] = "wrappingStrategy";
        // Leave these at the end (because they have dependencies!)
        EditorOption[EditorOption["editorClassName"] = 111] = "editorClassName";
        EditorOption[EditorOption["pixelRatio"] = 112] = "pixelRatio";
        EditorOption[EditorOption["tabFocusMode"] = 113] = "tabFocusMode";
        EditorOption[EditorOption["layoutInfo"] = 114] = "layoutInfo";
        EditorOption[EditorOption["wrappingInfo"] = 115] = "wrappingInfo";
    ...
    exports.EditorOptions = {
        ...
        useTabStops: register(new EditorBooleanOption(102 /* useTabStops */, 'useTabStops', true, { description: nls.localize('useTabStops', "Inserting and deleting whitespace follows tab stops.") })),
        wordSeparators: register(new EditorStringOption(103 /* wordSeparators */, 'wordSeparators', wordHelper_1.USUAL_WORD_SEPARATORS, { description: nls.localize('wordSeparators', "Characters that will be used as word separators when doing word related navigations or operations.") })),
        wordWrap: register(new EditorStringEnumOption(104 /* wordWrap */, 'wordWrap', 'off', ['off', 'on', 'wordWrapColumn', 'bounded'], {
            markdownEnumDescriptions: [
        ...
        wordWrapBreakAfterCharacters: register(new EditorStringOption(105 /* wordWrapBreakAfterCharacters */, 'wordWrapBreakAfterCharacters', ' \t})]?|/&.,;¢°′″‰℃、。｡､￠，．：；？！％・･ゝゞヽヾーァィゥェォッャュョヮヵヶぁぃぅぇぉっゃゅょゎゕゖㇰㇱㇲㇳㇴㇵㇶㇷㇸㇹㇺㇻㇼㇽㇾㇿ々〻ｧｨｩｪｫｬｭｮｯｰ”〉》」』】〕）］｝｣')),
        wordWrapBreakBeforeCharacters: register(new EditorStringOption(106 /* wordWrapBreakBeforeCharacters */, 'wordWrapBreakBeforeCharacters', '([{‘“〈《「『【〔（［｛｢£¥＄￡￥+＋')),
        wordWrapColumn: register(new EditorIntOption(107 /* wordWrapColumn */, 'wordWrapColumn', 80, 1, 1073741824 /* MAX_SAFE_SMALL_INTEGER */, {
            markdownDescription: nls.localize({
                key: 'wordWrapColumn',
                comment: [
        ...
        wordWrapMinified: register(new EditorBooleanOption(108 /* wordWrapMinified */, 'wordWrapMinified', true)),
        wrappingIndent: register(new EditorEnumOption(109 /* wrappingIndent */, 'wrappingIndent', 1 /* Same */, 'same', ['none', 'same', 'indent', 'deepIndent'], _wrappingIndentFromString, {
            enumDescriptions: [
        ...
        wrappingStrategy: register(new EditorStringEnumOption(110 /* wrappingStrategy */, 'wrappingStrategy', 'simple', ['simple', 'advanced'], {
            enumDescriptions: [
