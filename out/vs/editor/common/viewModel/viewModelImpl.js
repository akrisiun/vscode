    ...
    class ViewModel extends viewEvents.ViewEventEmitter {
        constructor(editorId, configuration, model, domLineBreaksComputerFactory, monospaceLineBreaksComputerFactory, scheduleAtNextAnimationFrame) {
            ...
            if (USE_IDENTITY_LINES_COLLECTION && this.model.isTooLargeForTokenization()) {
                ...
                const wrappingStrategy = options.get(110 /* wrappingStrategy */);
                const wrappingInfo = options.get(115 /* wrappingInfo */);
                const wrappingIndent = options.get(109 /* wrappingIndent */);
                this.lines = new splitLinesCollection_1.SplitLinesCollection(this.model, domLineBreaksComputerFactory, monospaceLineBreaksComputerFactory, fontInfo, this.model.getOptions().tabSize, wrappingStrategy, wrappingInfo.wrappingColumn, wrappingIndent);
            }
        ...
        getVisibleRangesPlusViewportAboveBelow() {
            const layoutInfo = this.configuration.options.get(114 /* layoutInfo */);
            const lineHeight = this.configuration.options.get(51 /* lineHeight */);
        ...
        getRichTextToCopy(modelRanges, emptySelectionClipboard) {
            ...
            const fontInfo = this.configuration.options.get(36 /* fontInfo */);
