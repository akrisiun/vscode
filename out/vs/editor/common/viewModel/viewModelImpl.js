    ...
    class ViewModel extends viewEvents.ViewEventEmitter {
        constructor(editorId, configuration, model, scheduleAtNextAnimationFrame) {
            ...
            if (USE_IDENTITY_LINES_COLLECTION && this.model.isTooLargeForTokenization()) {
                ...
                const wordWrapBreakAfterCharacters = options.get(92 /* wordWrapBreakAfterCharacters */);
                const wordWrapBreakBeforeCharacters = options.get(93 /* wordWrapBreakBeforeCharacters */);
                const wordWrapBreakObtrusiveCharacters = options.get(94 /* wordWrapBreakObtrusiveCharacters */);
                const wrappingIndent = options.get(97 /* wrappingIndent */);
        ...
        getAllOverviewRulerDecorations(theme) {
            return this.lines.getAllOverviewRulerDecorations(this.editorId, this.configuration.options.get(63 /* readOnly */), theme);
        }
        ...
        getHTMLToCopy(viewRanges, emptySelectionClipboard) {
            ...
            const fontInfo = this.configuration.options.get(30 /* fontInfo */);
