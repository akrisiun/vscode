 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "vs/base/common/types", "vs/base/common/uri", "vs/editor/common/core/range", "vs/editor/common/modes/languageFeatureRegistry", "vs/editor/common/modes/tokenizationRegistry", "vs/base/common/map"], function (require, exports, types_1, uri_1, range_1, languageFeatureRegistry_1, tokenizationRegistry_1, map_1) {
    "use strict";
    ...
    (function (SymbolKinds) {
         ...
         */
        function names() {
            return map_1.keys(byName);
        }
        SymbolKinds.names = names;
        /**
         * @internal
         */
