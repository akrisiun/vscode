...
define(["require", "exports", "vs/base/browser/dom", "vs/base/browser/fastDomNode", "vs/base/browser/globalMouseMoveMonitor", "vs/base/common/platform", "vs/base/common/strings", "vs/editor/browser/view/viewLayer", "vs/editor/browser/view/viewPart", "vs/editor/common/core/range", "vs/editor/common/view/minimapCharRenderer", "vs/editor/common/view/runtimeMinimapCharRenderer", "vs/editor/common/view/viewEvents", "vs/platform/theme/common/colorRegistry", "vs/platform/theme/common/themeService", "vs/base/browser/touch", "vs/css!./minimap"], function (require, exports, dom, fastDomNode_1, globalMouseMoveMonitor_1, platform, strings, viewLayer_1, viewPart_1, range_1, minimapCharRenderer_1, runtimeMinimapCharRenderer_1, viewEvents, colorRegistry_1, themeService_1, touch_1) {
    ...
    class MinimapOptions {
        constructor(configuration) {
            ...
            const pixelRatio = options.get(99 /* pixelRatio */);
            const layoutInfo = options.get(101 /* layoutInfo */);
            const fontInfo = options.get(30 /* fontInfo */);
            this.renderMinimap = layoutInfo.renderMinimap | 0;
            this.scrollBeyondLastLine = options.get(74 /* scrollBeyondLastLine */);
            const minimapOpts = options.get(50 /* minimap */);
