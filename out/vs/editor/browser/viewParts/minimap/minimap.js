 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "vs/base/browser/dom", "vs/base/browser/fastDomNode", "vs/base/browser/globalMouseMoveMonitor", "vs/base/common/lifecycle", "vs/base/common/platform", "vs/base/common/strings", "vs/editor/browser/view/viewLayer", "vs/editor/browser/view/viewPart", "vs/editor/common/config/editorOptions", "vs/editor/common/core/range", "vs/editor/common/core/rgba", "vs/editor/common/viewModel/minimapTokensColorTracker", "vs/editor/common/view/viewEvents", "vs/editor/common/viewModel/viewModel", "vs/platform/theme/common/colorRegistry", "vs/platform/theme/common/themeService", "vs/editor/common/core/selection", "vs/base/browser/touch", "vs/editor/browser/viewParts/minimap/minimapCharRendererFactory", "vs/editor/common/model", "vs/base/common/functional", "vs/css!./minimap"], function (require, exports, dom, fastDomNode_1, globalMouseMoveMonitor_1, lifecycle_1, platform, strings, viewLayer_1, viewPart_1, editorOptions_1, range_1, rgba_1, minimapTokensColorTracker_1, viewEvents, viewModel_1, colorRegistry_1, themeService_1, selection_1, touch_1, minimapCharRendererFactory_1, model_1, functional_1) {
    "use strict";
    ...
    class MinimapOptions {
        constructor(configuration, theme, tokensColorTracker) {
            ...
            const pixelRatio = options.get(112 /* pixelRatio */);
    ...
    class Minimap extends viewPart_1.ViewPart {
        ...
        revealLineNumber(lineNumber) {
            ...
            this._context.privateViewEventBus.emit(new viewEvents.ViewRevealRangeRequestEvent('mouse', new range_1.Range(lineNumber, 1, lineNumber, 1), null, 1 /* Center */, false, 0 /* Smooth */));
        }
