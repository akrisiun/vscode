...
define(["require", "exports", "vs/nls", "vs/base/common/types", "vs/editor/browser/editorExtensions", "vs/editor/browser/services/codeEditorService", "vs/editor/common/controller/cursorColumnSelection", "vs/editor/common/controller/cursorCommon", "vs/editor/common/controller/cursorDeleteOperations", "vs/editor/common/controller/cursorMoveCommands", "vs/editor/common/controller/cursorTypeOperations", "vs/editor/common/core/position", "vs/editor/common/core/range", "vs/editor/common/editorCommon", "vs/editor/common/editorContextKeys", "vs/platform/actions/common/actions", "vs/platform/contextkey/common/contextkey", "vs/platform/keybinding/common/keybindingsRegistry"], function (require, exports, nls, types, editorExtensions_1, codeEditorService_1, cursorColumnSelection_1, cursorCommon_1, cursorDeleteOperations_1, cursorMoveCommands_1, cursorTypeOperations_1, position_1, range_1, editorCommon_1, editorContextKeys_1, actions_1, contextkey_1, keybindingsRegistry_1) {
    ...
    (function (CoreEditingCommands) {
        ...
        CoreEditingCommands.Undo = registerCommand(new UndoCommand({
            id: 'undo',
            precondition: editorContextKeys_1.EditorContextKeys.writable,
            kbOpts: {
                weight: CORE_WEIGHT,
        ...
        CoreEditingCommands.DefaultUndo = registerCommand(new UndoCommand({ id: 'default:undo', precondition: editorContextKeys_1.EditorContextKeys.writable }));
        CoreEditingCommands.Redo = registerCommand(new RedoCommand({
            id: 'redo',
            precondition: editorContextKeys_1.EditorContextKeys.writable,
            kbOpts: {
                weight: CORE_WEIGHT,
        ...
        CoreEditingCommands.DefaultRedo = registerCommand(new RedoCommand({ id: 'default:redo', precondition: editorContextKeys_1.EditorContextKeys.writable }));
