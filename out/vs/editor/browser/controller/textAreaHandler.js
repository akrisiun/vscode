    ...
    class TextAreaHandler extends viewPart_1.ViewPart {
        constructor(context, viewController, viewHelper) {
            ...
            this._register(this._textAreaInput.onCompositionStart((e) => {
                ...
                this._context.privateViewEventBus.emit(new viewEvents.ViewRevealRangeRequestEvent('keyboard', new range_1.Range(lineNumber, column, lineNumber, column), null, 0 /* Simple */, true, 1 /* Immediate */));
        ...
        _getWordBeforePosition(position) {
            ...
            const wordSeparators = wordCharacterClassifier_1.getMapForWordSeparators(this._context.configuration.options.get(103 /* wordSeparators */));
