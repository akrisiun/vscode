...
define(["require", "exports", "assert", "vs/editor/common/core/editOperation", "vs/editor/common/core/position", "vs/editor/common/core/range", "vs/editor/test/common/editorTestUtils"], function (require, exports, assert, editOperation_1, position_1, range_1, editorTestUtils_1) {
    ...
    suite('Editor Model - Model Decorations', () => {
        ...
        test('removeAllDecorationsWithOwnerId can be called after model dispose', () => {
            let model = editorTestUtils_1.createTextModel('asd');
            model.dispose();
    ...
    suite('deltaDecorations', () => {
        ...
        function testDeltaDecorations(text, decorations, newDecorations) {
            let model = editorTestUtils_1.createTextModel(text.join('\n'));
        ...
        test('issue #4317: editor.setDecorations doesn\'t update the hover message', () => {
            let model = editorTestUtils_1.createTextModel('Hello world!');
            let ids = model.deltaDecorations([], [{
                    range: {
                        startLineNumber: 1,
                        startColumn: 1,
