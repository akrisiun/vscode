...
define(["require", "exports", "assert", "vs/base/common/lifecycle", "vs/editor/common/core/editOperation", "vs/editor/common/core/position", "vs/editor/common/core/range", "vs/editor/common/core/token", "vs/editor/common/model/textModelEvents", "vs/editor/common/modes", "vs/editor/common/modes/languageConfigurationRegistry", "vs/editor/common/modes/nullMode", "vs/editor/test/common/mocks/mockMode", "vs/editor/test/common/editorTestUtils"], function (require, exports, assert, lifecycle_1, editOperation_1, position_1, range_1, token_1, textModelEvents_1, modes_1, languageConfigurationRegistry_1, nullMode_1, mockMode_1, editorTestUtils_1) {
    ...
    suite('Editor Model - Model Line Separators', () => {
        ...
        test('Bug 13333:Model should line break on lonely CR too', () => {
            let model = editorTestUtils_1.createTextModel('Hello\rWorld!\r\nAnother line');
    ...
    suite('Editor Model - Words', () => {
        ...
        test('Get word at position', () => {
            ...
            const thisModel = editorTestUtils_1.createTextModel(text.join('\n'));
        ...
        test('getWordAtPosition at embedded language boundaries', () => {
            ...
            const model = editorTestUtils_1.createTextModel('ab<xx>ab<x>', undefined, outerMode.getLanguageIdentifier());
        ...
        test('issue #61296: VS code freezes when editing CSS file with emoji', () => {
            ...
            const thisModel = editorTestUtils_1.createTextModel('.🐷-a-b', undefined, MODE_ID);
            disposables.push(thisModel);
