...
define(["require", "exports", "assert", "vs/editor/common/core/lineTokens", "vs/editor/common/core/range", "vs/editor/common/model/textModel", "vs/editor/common/modes", "vs/editor/test/common/core/viewLineToken", "vs/editor/test/common/editorTestUtils"], function (require, exports, assert, lineTokens_1, range_1, textModel_1, modes_1, viewLineToken_1, editorTestUtils_1) {
    ...
    suite('ModelLinesTokens', () => {
        function testApplyEdits(initial, edits, expected) {
            ...
            const model = editorTestUtils_1.createTextModel(initialText, textModel_1.TextModel.DEFAULT_CREATION_OPTIONS, new modes_1.LanguageIdentifier('test', 0));
        ...
        test('insertion on empty line', () => {
            const model = editorTestUtils_1.createTextModel('some text', textModel_1.TextModel.DEFAULT_CREATION_OPTIONS, new modes_1.LanguageIdentifier('test', 0));
