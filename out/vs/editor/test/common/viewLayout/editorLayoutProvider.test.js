...
define(["require", "exports", "assert", "vs/editor/common/config/editorOptions", "vs/editor/common/config/commonEditorConfig"], function (require, exports, assert, editorOptions_1, commonEditorConfig_1) {
    ...
    suite('Editor ViewLayout - EditorLayoutProvider', () => {
        function doTest(input, expected) {
            ...
            options._write(36 /* glyphMargin */, input.showGlyphMargin);
            options._write(47 /* lineNumbersMinChars */, input.lineNumbersMinChars);
            options._write(44 /* lineDecorationsWidth */, input.lineDecorationsWidth);
            options._write(27 /* folding */, false);
            ...
            options._write(50 /* minimap */, minimapOptions);
            ...
            options._write(72 /* scrollbar */, scrollbarOptions);
            const lineNumbersOptions = {
                renderType: input.showLineNumbers ? 1 /* On */ : 0 /* Off */,
                renderFn: null
            };
            options._write(46 /* lineNumbers */, lineNumbersOptions);
