 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/editor/common/controller/cursor", "vs/editor/common/core/editOperation", "vs/editor/common/core/position", "vs/editor/common/core/range", "vs/editor/common/core/selection", "vs/editor/test/common/editorTestUtils", "vs/editor/common/viewModel/viewModelImpl", "vs/editor/test/browser/testCodeEditor", "vs/editor/test/common/mocks/testConfiguration", "vs/editor/common/viewModel/monospaceLineBreaksComputer"], function (require, exports, assert, cursor_1, editOperation_1, position_1, range_1, selection_1, editorTestUtils_1, viewModelImpl_1, testCodeEditor_1, testConfiguration_1, monospaceLineBreaksComputer_1) {
    "use strict";
    ...
    suite('SideEditing', () => {
        ...
        function _runTest(selection, editRange, editText, editForceMoveMarkers, expected, msg) {
            const model = editorTestUtils_1.createTextModel(LINES.join('\n'));
            const config = new testConfiguration_1.TestConfiguration({});
            const monospaceLineBreaksComputerFactory = monospaceLineBreaksComputer_1.MonospaceLineBreaksComputerFactory.create(config.options);
            const viewModel = new viewModelImpl_1.ViewModel(0, config, model, monospaceLineBreaksComputerFactory, monospaceLineBreaksComputerFactory, null);
