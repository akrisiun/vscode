...
define(["require", "exports", "assert", "vs/editor/browser/controller/coreCommands", "vs/editor/common/controller/cursor", "vs/editor/common/core/editOperation", "vs/editor/common/core/position", "vs/editor/common/core/range", "vs/editor/common/core/selection", "vs/editor/common/core/token", "vs/editor/common/editorCommon", "vs/editor/common/model/textModel", "vs/editor/common/modes", "vs/editor/common/modes/languageConfiguration", "vs/editor/common/modes/languageConfigurationRegistry", "vs/editor/common/modes/nullMode", "vs/editor/common/viewModel/viewModelImpl", "vs/editor/test/browser/testCodeEditor", "vs/editor/test/common/editorTestUtils", "vs/editor/test/common/mocks/mockMode", "vs/editor/test/common/mocks/testConfiguration", "vs/editor/test/common/modes/supports/javascriptOnEnterRules", "vs/editor/common/viewModel/monospaceLineBreaksComputer"], function (require, exports, assert, coreCommands_1, cursor_1, editOperation_1, position_1, range_1, selection_1, token_1, editorCommon_1, textModel_1, modes_1, languageConfiguration_1, languageConfigurationRegistry_1, nullMode_1, viewModelImpl_1, testCodeEditor_1, editorTestUtils_1, mockMode_1, testConfiguration_1, javascriptOnEnterRules_1, monospaceLineBreaksComputer_1) {
    ...
    function createViewModel(configuration, model) {
        ...
        return new viewModelImpl_1.ViewModel(0, configuration, model, monospaceLineBreaksComputerFactory, monospaceLineBreaksComputerFactory, null);
    }
    suite('Editor Controller - Cursor', () => {
        ...
        test('issue #44465: cursor position not correct when move', () => {
            thisCursor.setSelections('test', [new selection_1.Selection(1, 5, 1, 5)]);
    ...
    suite('Editor Controller - Regression tests', () => {
        ...
        test('issue #46208: Allow empty selections in the undo/redo stack', () => {
            ...
            testCodeEditor_1.withTestCodeEditor(null, { model: model }, (editor, cursor) => {
                ...
                coreCommands_1.CoreEditingCommands.Undo.runEditorCommand(null, editor, null);
                assert.equal(model.getLineContent(1), 'Hello world ');
                assertCursor(cursor, new selection_1.Selection(1, 12, 1, 13));
                coreCommands_1.CoreEditingCommands.Undo.runEditorCommand(null, editor, null);
                assert.equal(model.getLineContent(1), 'Hello world');
                assertCursor(cursor, new position_1.Position(1, 12));
                coreCommands_1.CoreEditingCommands.Undo.runEditorCommand(null, editor, null);
        ...
        test('issue #95591: Unindenting moves cursor to beginning of line', () => {
            ...
            testCodeEditor_1.withTestCodeEditor(null, {
                model: model,
                useTabStops: false
            }, (editor, cursor) => {
        ...
        test('issue #9675: Undo/Redo adds a stop in between CHN Characters', () => {
            testCodeEditor_1.withTestCodeEditor([], {}, (editor, cursor) => {
                const model = editor.getModel();
                assertCursor(cursor, new position_1.Position(1, 1));
        ...
        test('issue #84897: Left delete behavior in some languages is changed', () => {
            ...
            testCodeEditor_1.withTestCodeEditor(null, { model: model }, (editor, cursor) => {
                ...
                coreCommands_1.CoreEditingCommands.DeleteLeft.runEditorCommand(null, editor, null);
                assert.equal(model.getValue(1 /* LF */), 'สวัสด');
                coreCommands_1.CoreEditingCommands.DeleteLeft.runEditorCommand(null, editor, null);
                assert.equal(model.getValue(1 /* LF */), 'สวัส');
                coreCommands_1.CoreEditingCommands.DeleteLeft.runEditorCommand(null, editor, null);
                assert.equal(model.getValue(1 /* LF */), 'สวั');
                coreCommands_1.CoreEditingCommands.DeleteLeft.runEditorCommand(null, editor, null);
                assert.equal(model.getValue(1 /* LF */), 'สว');
                coreCommands_1.CoreEditingCommands.DeleteLeft.runEditorCommand(null, editor, null);
                assert.equal(model.getValue(1 /* LF */), 'ส');
                coreCommands_1.CoreEditingCommands.DeleteLeft.runEditorCommand(null, editor, null);
                assert.equal(model.getValue(1 /* LF */), '');
            });
            model.dispose();
    ...
    suite('Editor Controller - Indentation Rules', () => {
        ...
        test('Enter honors indentNextLinePattern 2', () => {
            ...
            testCodeEditor_1.withTestCodeEditor(null, { model: model, autoIndent: 'full' }, (editor, cursor) => {
        ...
        test('issue #36090: JS: editor.autoIndent seems to be broken', () => {
            ...
            testCodeEditor_1.withTestCodeEditor(null, { model: model, autoIndent: 'advanced' }, (editor, cursor) => {
    ...
    suite('autoClosingPairs', () => {
        ...
        test('issue #90016: allow accents on mac US intl keyboard to surround selection', () => {
            ...
            usingCursor({
                ...
                cursor.setSelections('test', [new selection_1.Selection(1, 1, 1, 5)]);
                // Typing ` + e on the mac US intl kb layout
                cursorCommand(cursor, H.CompositionStart, null, 'keyboard');
                cursorCommand(cursor, H.Type, { text: '\'' }, 'keyboard');
