 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/editor/browser/controller/coreCommands", "vs/editor/common/controller/cursor", "vs/editor/common/controller/cursorMoveCommands", "vs/editor/common/core/position", "vs/editor/common/core/range", "vs/editor/common/viewModel/viewModelImpl", "vs/editor/test/common/mocks/testConfiguration", "vs/editor/common/viewModel/monospaceLineBreaksComputer", "vs/editor/test/common/editorTestUtils"], function (require, exports, assert, coreCommands_1, cursor_1, cursorMoveCommands_1, position_1, range_1, viewModelImpl_1, testConfiguration_1, monospaceLineBreaksComputer_1, editorTestUtils_1) {
    "use strict";
    ...
    suite('Cursor move command test', () => {
        ...
        setup(() => {
            ...
            const monospaceLineBreaksComputerFactory = monospaceLineBreaksComputer_1.MonospaceLineBreaksComputerFactory.create(thisConfiguration.options);
            thisViewModel = new viewModelImpl_1.ViewModel(0, thisConfiguration, thisModel, monospaceLineBreaksComputerFactory, monospaceLineBreaksComputerFactory, null);
