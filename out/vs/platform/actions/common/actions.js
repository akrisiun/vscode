...
define(["require", "exports", "vs/base/common/actions", "vs/platform/instantiation/common/descriptors", "vs/platform/instantiation/common/instantiation", "vs/platform/keybinding/common/keybindingsRegistry", "vs/platform/contextkey/common/contextkey", "vs/platform/commands/common/commands", "vs/base/common/lifecycle", "vs/base/common/event"], function (require, exports, actions_1, descriptors_1, instantiation_1, keybindingsRegistry_1, contextkey_1, commands_1, lifecycle_1, event_1) {
    ...
    let ExecuteCommandAction = /** @class */ (() => {
    ...
    function registerAction2(ctor) {
        ...
        if (Array.isArray(menu)) {
            for (let item of menu) {
                disposables.add(exports.MenuRegistry.appendMenuItem(item.id, Object.assign({ command: Object.assign({}, command) }, item)));
            }
        }
        else if (menu) {
            disposables.add(exports.MenuRegistry.appendMenuItem(menu.id, Object.assign({ command: Object.assign({}, command) }, menu)));
        }
        if (f1) {
            disposables.add(exports.MenuRegistry.appendMenuItem(MenuId.CommandPalette, { command: command }));
        }
        // keybinding
