    ...
    let FileService = /** @class */ (() => {
        let FileService = class FileService extends lifecycle_1.Disposable {
            ...
            registerProvider(scheme, provider) {
                ...
                providerDisposables.add(provider.onDidChangeFile(changes => this._onDidFilesChange.fire(new files_1.FileChangesEvent(changes))));
            ...
            transformFileReadStream(resource, stream, options) {
