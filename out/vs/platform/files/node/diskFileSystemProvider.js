...
define(["require", "exports", "fs", "util", "vs/base/common/lifecycle", "vs/platform/files/common/files", "vs/base/common/event", "vs/base/common/platform", "vs/base/node/pfs", "vs/base/common/path", "vs/base/common/resources", "vs/base/common/extpath", "vs/base/common/async", "vs/platform/log/common/log", "vs/nls", "vs/platform/files/node/watcher/watcher", "vs/platform/files/node/watcher/unix/watcherService", "vs/platform/files/node/watcher/win32/watcherService", "vs/platform/files/node/watcher/nsfw/watcherService", "vs/platform/files/node/watcher/nodejs/watcherService", "vs/base/common/buffer", "vs/base/common/stream", "vs/platform/files/common/io", "vs/base/common/arrays"], function (require, exports, fs_1, util_1, lifecycle_1, files_1, event_1, platform_1, pfs_1, path_1, resources_1, extpath_1, async_1, log_1, nls_1, watcher_1, watcherService_1, watcherService_2, watcherService_3, watcherService_4, buffer_1, stream_1, io_1, arrays_1) {
    ...
    class DiskFileSystemProvider extends lifecycle_1.Disposable {
        ...
        readFileStream(resource, opts, token) {
            const fileStream = io_1.createReadStream(this, resource, Object.assign(Object.assign({}, opts), { bufferSize: this.BUFFER_SIZE }), token);
            return stream_1.transform(fileStream, { data: data => data.buffer }, data => buffer_1.VSBuffer.concat(data.map(data => buffer_1.VSBuffer.wrap(data))).buffer);
        }
        async writeFile(resource, content, opts) {
            ...
            try {
                ...
                if (!opts.create || !opts.overwrite) {
                    ...
                    if (fileExists) {
                        if (!opts.overwrite) {
                            throw files_1.createFileSystemProviderError(nls_1.localize('fileExists', "File already exists"), files_1.FileSystemProviderErrorCode.FileExists);
                        }
                    }
                    else {
                        if (!opts.create) {
        ...
        async validateTargetDeleted(from, to, mode, overwrite) {
            ...
            if (isSameResourceWithDifferentPathCase && mode === 'copy') {
                throw files_1.createFileSystemProviderError(nls_1.localize('fileCopyErrorPathCase', "'File cannot be copied to same path with different path case"), files_1.FileSystemProviderErrorCode.FileExists);
            }
            // handle existing target (unless this is a case change)
            if (!isSameResourceWithDifferentPathCase && await pfs_1.exists(toFilePath)) {
                if (!overwrite) {
                    throw files_1.createFileSystemProviderError(nls_1.localize('fileCopyErrorExists', "File at target already exists"), files_1.FileSystemProviderErrorCode.FileExists);
                }
                // Delete target
