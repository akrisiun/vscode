...
define(["require", "exports", "vs/platform/telemetry/node/commonProperties", "vs/platform/telemetry/common/telemetry", "vs/platform/telemetry/common/telemetryUtils"], function (require, exports, commonProperties_1, telemetry_1, telemetryUtils_1) {
    ...
    async function resolveWorkbenchCommonProperties(storageService, commit, version, machineId, msftInternalDomains, installSourcePath, remoteAuthority, resolveAdditionalProperties) {
        const result = await commonProperties_1.resolveCommonProperties(commit, version, machineId, msftInternalDomains, installSourcePath, undefined, resolveAdditionalProperties);
