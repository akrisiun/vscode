define(["require", "exports", "assert", "vs/platform/telemetry/node/appInsightsAppender", "vs/platform/log/common/log", "applicationinsights"], function (require, exports, assert, appInsightsAppender_1, log_1, applicationinsights_1) {
    "use strict";
