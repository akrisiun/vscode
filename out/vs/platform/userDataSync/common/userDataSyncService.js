...
define(["require", "exports", "vs/platform/userDataSync/common/userDataSync", "vs/base/common/lifecycle", "vs/platform/instantiation/common/instantiation", "vs/base/common/event", "vs/platform/userDataSync/common/extensionsSync", "vs/platform/userDataSync/common/keybindingsSync", "vs/platform/userDataSync/common/globalStateSync", "vs/base/common/errorMessage", "vs/platform/telemetry/common/telemetry", "vs/base/common/arrays", "vs/nls", "vs/platform/storage/common/storage", "vs/platform/userDataSync/common/settingsSync", "vs/base/common/resources", "vs/platform/userDataSync/common/snippetsSync"], function (require, exports, userDataSync_1, lifecycle_1, instantiation_1, event_1, extensionsSync_1, keybindingsSync_1, globalStateSync_1, errorMessage_1, telemetry_1, arrays_1, nls_1, storage_1, settingsSync_1, resources_1, snippetsSync_1) {
    "use strict";
    ...
    let UserDataSyncService = /** @class */ (() => {
        let UserDataSyncService = class UserDataSyncService extends lifecycle_1.Disposable {
            ...
            async sync() {
                ...
                try {
                    ...
                    if (manifest === null && await this.hasPreviouslySynced()) {
                        ...
                        throw new userDataSync_1.UserDataSyncError(nls_1.localize('turned off', "Cannot sync because syncing is turned off in the cloud"), userDataSync_1.UserDataSyncErrorCode.TurnedOff);
                    }
                    const sessionId = this.storageService.get(SESSION_ID_KEY, 0 /* GLOBAL */);
                    // Server session is different from client session
                    if (sessionId && manifest && sessionId !== manifest.session) {
                        throw new userDataSync_1.UserDataSyncError(nls_1.localize('session expired', "Cannot sync because current session is expired"), userDataSync_1.UserDataSyncErrorCode.SessionExpired);
                    }
                    for (const synchroniser of this.synchronisers) {
                        try {
                    ...
                    if (manifest && manifest.session !== sessionId) {
                        this.storageService.store(SESSION_ID_KEY, manifest.session, 0 /* GLOBAL */);
                    }
            ...
            async isFirstTimeSyncWithMerge() {
                await this.checkEnablement();
            ...
            async resetLocal() {
                await this.checkEnablement();
                this.storageService.remove(SESSION_ID_KEY, 0 /* GLOBAL */);
