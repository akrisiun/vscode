...
define(["require", "exports", "vs/nls", "vs/base/common/path", "vs/base/node/pfs", "vs/base/common/objects", "vs/base/common/lifecycle", "vs/base/common/arrays", "vs/base/node/zip", "vs/platform/extensionManagement/common/extensionManagement", "vs/platform/extensionManagement/common/extensionManagementUtil", "../common/extensionNls", "vs/platform/environment/common/environment", "vs/base/common/async", "vs/base/common/event", "semver-umd", "vs/base/common/uri", "vs/platform/product/common/product", "vs/base/common/platform", "vs/platform/log/common/log", "vs/platform/extensionManagement/node/extensionsManifestCache", "vs/platform/extensionManagement/node/extensionLifecycle", "vs/base/common/errorMessage", "vs/platform/telemetry/common/telemetry", "vs/platform/extensions/common/extensionValidator", "os", "vs/base/common/uuid", "vs/platform/download/common/download", "vs/platform/instantiation/common/instantiation", "vs/base/common/network", "vs/base/common/cancellation", "vs/base/common/amd", "vs/platform/extensionManagement/node/extensionManagementUtil", "vs/platform/extensionManagement/node/extensionDownloader"], function (require, exports, nls, path, pfs, objects_1, lifecycle_1, arrays_1, zip_1, extensionManagement_1, extensionManagementUtil_1, extensionNls_1, environment_1, async_1, event_1, semver, uri_1, product_1, platform_1, log_1, extensionsManifestCache_1, extensionLifecycle_1, errorMessage_1, telemetry_1, extensionValidator_1, os_1, uuid_1, download_1, instantiation_1, network_1, cancellation_1, amd_1, extensionManagementUtil_2, extensionDownloader_1) {
    ...
    let ExtensionManagementService = /** @class */ (() => {
        let ExtensionManagementService = class ExtensionManagementService extends lifecycle_1.Disposable {
            ...
            extract(identifier, zipPath, extractPath, token) {
                ...
                return pfs.rimraf(extractPath)
                    ...
                    .then(() => this.logService.info(`Extracted extension to ${extractPath}:`, identifier.id), e => pfs.rimraf(extractPath).finally(() => { })
            ...
            async removeDeprecatedExtensions() {
                await this.removeUninstalledExtensions();
                await this.removeOutdatedExtensions();
            }
            async removeUninstalledExtensions() {
                const uninstalled = await this.getUninstalledExtensions();
                const extensions = await this.scanExtensions(this.extensionsPath, 1 /* User */); // All user extensions
            ...
            getDevSystemExtensionsList() {
                return Promise.resolve(product_1.default.builtInExtensions ? product_1.default.builtInExtensions.map(e => e.name) : []);
            }
