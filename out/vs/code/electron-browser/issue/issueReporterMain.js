...
define(["require", "exports", "electron", "os", "vs/base/browser/browser", "vs/base/browser/dom", "vs/base/browser/ui/button/button", "vs/base/browser/ui/codicons/codiconLabel", "vs/base/common/collections", "vs/base/common/decorators", "vs/base/common/lifecycle", "vs/base/common/platform", "vs/base/common/strings", "vs/base/parts/ipc/common/ipc", "vs/base/parts/ipc/node/ipc", "vs/base/parts/ipc/node/ipc.net", "vs/platform/issue/common/issueReporterUtil", "vs/code/electron-browser/issue/issueReporterModel", "vs/code/electron-browser/issue/issueReporterPage", "vs/nls", "vs/platform/diagnostics/common/diagnostics", "vs/platform/environment/node/environmentService", "vs/platform/instantiation/common/instantiationService", "vs/platform/instantiation/common/serviceCollection", "vs/platform/ipc/electron-browser/mainProcessService", "vs/platform/log/common/log", "vs/platform/log/common/logIpc", "vs/platform/log/node/spdlogService", "vs/platform/product/common/product", "vs/platform/telemetry/common/telemetryService", "vs/platform/telemetry/common/telemetryUtils", "vs/platform/telemetry/node/commonProperties", "vs/platform/telemetry/node/telemetryIpc", "vs/base/browser/ui/codicons/codiconStyles", "vs/css!./media/issueReporter"], function (require, exports, electron_1, os, browser, dom_1, button_1, codiconLabel_1, collections, decorators_1, lifecycle_1, platform, strings_1, ipc_1, ipc_2, ipc_net_1, issueReporterUtil_1, issueReporterModel_1, issueReporterPage_1, nls_1, diagnostics_1, environmentService_1, instantiationService_1, serviceCollection_1, mainProcessService_1, log_1, logIpc_1, spdlogService_1, product_1, telemetryService_1, telemetryUtils_1, commonProperties_1, telemetryIpc_1) {
    "use strict";
    ...
    let IssueReporter = /** @class */ (() => {
        class IssueReporter extends lifecycle_1.Disposable {
            ...
            logSearchError(error) {
                ...
                this.telemetryService.publicLogError2('issueReporterSearchError', { message: error.message });
            }
            setUpTypes() {
