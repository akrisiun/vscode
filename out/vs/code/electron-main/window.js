    ...
    let CodeWindow = /** @class */ (() => {
        let CodeWindow = class CodeWindow extends lifecycle_1.Disposable {
            ...
            getUrl(windowConfiguration) {
                ...
                if ((windowConfig === null || windowConfig === void 0 ? void 0 : windowConfig.autoDetectHighContrast) === false) {
                    autoDetectHighContrast = false;
                }
                windowConfiguration.highContrast = platform_1.isWindows && autoDetectHighContrast && electron_1.nativeTheme.shouldUseInvertedColorScheme;
            ...
            validateWindowState(state, displays) {
                ...
                const display = electron_1.screen.getDisplayMatching({ x: state.x, y: state.y, width: state.width, height: state.height });
