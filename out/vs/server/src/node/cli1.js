define(["require", "exports", "child_process", "os", "path", "../../../../vs/base/common/errors", "../../../../vs/code/node/cliProcessMain", "../../../../vs/code/node/paths", "../../../../vs/platform/environment/node/argv", "../../../../vs/platform/environment/node/argvHelper", "../../../../vs/platform/product/common/product", "./util", "./ipc", "./marketplace", "./server"], function (require, exports, cp, os, path, errors_1, cliProcessMain_1, paths_1, argv_1, argvHelper_1, product_1, util_1, ipc_1, marketplace_1, server_1) {
    "use strict";
    ...
    const startVscode = () => {
        ...
        if (!options.cert && typeof options.cert !== "undefined") {
            ...
            util_1.generateCertificate().then(({ cert, certKey }) => {
                // const cert = a;
                // const certKey = b;
                options.cert = cert;
