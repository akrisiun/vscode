            ...
            this.actionBar = this._register(new actionbar_1.ActionBar(element, {
                ...
                actionViewItemProvider: (action) => {
                    ...
                    if (action.id === ToggleMenuAction.ID) {
                        // Create new
                        this.toggleMenuActionViewItem.value = new dropdown_1.DropdownMenuActionViewItem(action, action.menuActions, contextMenuProvider, this.options.actionViewItemProvider, this.actionRunner, this.options.getKeyBinding, toolBarMoreIcon.classNames, this.options.anchorAlignmentProvider);
