...
define(["require", "exports", "vs/base/common/lifecycle", "vs/base/common/arrays", "./listWidget", "vs/base/common/event", "vs/base/common/cancellation", "vs/css!./list"], function (require, exports, lifecycle_1, arrays_1, listWidget_1, event_1, cancellation_1) {
    ...
    class PagedList {
        ...
        get onDidChangeFocus() {
            return event_1.Event.map(this.list.onDidChangeFocus, ({ elements, indexes }) => ({ elements: elements.map(e => this._model.get(e)), indexes }));
        }
        get onDidOpen() {
        ...
        get onDidChangeSelection() {
            return event_1.Event.map(this.list.onDidChangeSelection, ({ elements, indexes }) => ({ elements: elements.map(e => this._model.get(e)), indexes }));
        }
        get onPin() {
