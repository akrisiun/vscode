    ...
    let Pane = /** @class */ (() => {
        class Pane extends lifecycle_1.Disposable {
            ...
            get minimumSize() {
                ...
                const minimumBodySize = expanded ? this.minimumBodySize : this._orientation === 1 /* HORIZONTAL */ ? 50 : 0;
                return headerSize + minimumBodySize;
            }
            get maximumSize() {
                const headerSize = this.headerSize;
                const expanded = !this.headerVisible || this.isExpanded();
                const maximumBodySize = expanded ? this.maximumBodySize : this._orientation === 1 /* HORIZONTAL */ ? 50 : 0;
