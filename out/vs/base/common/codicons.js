...
define(["require", "exports", "vs/base/common/codicon", "vs/base/common/event"], function (require, exports, codicon_1, event_1) {
    ...
    (function (Codicon) {
        ...
        Codicon.compareChanges = new Codicon('compare-changes', { character: '\\eac8' });
        ...
        Codicon.debugAlternate = new Codicon('debug-alternate', { character: '\\eb91' });
        ...
        Codicon.debugAlt2 = new Codicon('debug-alt-2', { character: '\\f101' });
        Codicon.debugAlt = new Codicon('debug-alt', { character: '\\f102' });
