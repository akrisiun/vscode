...
function registerAPICommands(extension) {
    return vscode_1.Disposable.from(vscode_1.commands.registerCommand('git.api.getRepositories', () => {
        const api = extension.getAPI(1);
        return api.repositories.map(r => r.rootUri.toString());
    }), vscode_1.commands.registerCommand('git.api.getRepositoryState', (uri) => {
        const api = extension.getAPI(1);
