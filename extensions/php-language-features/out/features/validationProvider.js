...
class PHPValidationProvider {
    ...
    loadConfiguration() {
        ...
        if (section) {
            ...
            let inspect = section.inspect('validate.executablePath');
        ...
        if (this.executableIsUserDefined !== true && this.workspaceStore.get(CheckedExecutablePath, undefined) !== undefined) {
    ...
    triggerValidate(textDocument) {
        ...
        if (this.executableIsUserDefined !== undefined && !this.executableIsUserDefined) {
            let checkedExecutablePath = this.workspaceStore.get(CheckedExecutablePath, undefined);
