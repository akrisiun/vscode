...
let MarkdownPreviewManager = /** @class */ (() => {
    class MarkdownPreviewManager extends dispose_1.Disposable {
        ...
        async deserializeWebviewPanel(webview, state) {
            ...
            const preview = await preview_1.DynamicMarkdownPreview.revive({ resource, locked, line, resourceColumn }, webview, this._contentProvider, this._previewConfigurations, this._logger, this._topmostLineMonitor, this._contributions);
            this.registerDynamicPreview(preview);
        }
        async resolveCustomTextEditor(document, webview) {
            const preview = preview_1.StaticMarkdownPreview.revive(document.uri, webview, this._contentProvider, this._previewConfigurations, this._logger, this._contributions);
        ...
        createNewDynamicPreview(resource, previewSettings) {
            ...
            }, previewSettings.previewColumn, this._contentProvider, this._previewConfigurations, this._logger, this._topmostLineMonitor, this._contributions);
