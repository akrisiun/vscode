...
class MarkdownPreview extends dispose_1.Disposable {
    constructor(webview, resource, startingScroll, delegate, _contentProvider, _previewConfigurations, _logger, _contributionProvider) {
        super();
...
class StaticMarkdownPreview extends dispose_1.Disposable {
    constructor(_webviewPanel, resource, contentProvider, _previewConfigurations, logger, contributionProvider) {
        super();
    ...
    static revive(resource, webview, contentProvider, previewConfigurations, logger, contributionProvider) {
 ...
 * A
 */
let DynamicMarkdownPreview = /** @class */ (() => {
    class DynamicMarkdownPreview extends dispose_1.Disposable {
        constructor(webview, input, _contentProvider, _previewConfigurations, _logger, _topmostLineMonitor, _contributionProvider) {
            super();
            this._contentProvider = _contentProvider;
            this._previewConfigurations = _previewConfigurations;
            this._logger = _logger;
            ...
            this._register(vscode.window.onDidChangeActiveTextEditor(editor => {
                if (editor && file_1.isMarkdownFile(editor.document) && !this._locked && !this._preview.isPreviewOf(editor.document.uri)) {
        ...
        createPreview(resource, startingScroll) {
            ...
            }, this._contentProvider, this._previewConfigurations, this._logger, this._contributionProvider);
        }
    }
    DynamicMarkdownPreview.viewType = 'markdown.preview';
    return DynamicMarkdownPreview;
})();
