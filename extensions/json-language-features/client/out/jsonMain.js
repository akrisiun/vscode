        ...
        client.onRequest(VSCodeContentRequest.type, (uriPath) => {
            ...
            if (uri.scheme !== 'http' && uri.scheme !== 'https') {
                ...
                return request_light_1.xhr({ url: uriPath, followRedirects: 5, headers }).then(response => {
                    ...
                    return Promise.reject(new vscode_languageclient_1.ResponseError(error.status, error.responseText || request_light_1.getErrorStatusDescription(error.status) || error.toString()));
                });
            }
        });
