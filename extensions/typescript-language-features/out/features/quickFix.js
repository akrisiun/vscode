...
let TypeScriptQuickFixProvider = /** @class */ (() => {
    class TypeScriptQuickFixProvider {
        ...
        addFixAllForTsCodeAction(results, document, file, diagnostic, tsAction) {
            ...
            const action = new VsCodeCodeAction(tsAction, tsAction.fixAllDescription || localize('fixAllInFileLabel', '{0} (Fix all in file)', tsAction.description), vscode.CodeActionKind.QuickFix);
...
function isPreferredFix(tsAction, allActions) {
